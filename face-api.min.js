!(function (t, e) {
	...
	function b(t, e, n) {
		if ((void 0 === e && (e = []), void 0 === n && (n = !1), null == e && (e = []), Array.isArray(t) || (z(t) && !n))) for (var r = 0; r < t.length; ++r) b(t[r], e, n);
		else e.push(t);
		return e;
	}
	function L(t) {
	...
	var at = Object.freeze({
		...
		st =
			((ut.prototype.profileKernel = function (o, i, t) {
				var e,
					a = this,
	...
	var ct =
		((lt.prototype.logKernelProfile = function (t, e, n, r, o, i) {
	...
	var bt =
			...
			return (
				...
				(function (t, e, n, r) {
					var o = Y(e),
						...
						u = ['Tensor'];
					return (
						r && (u.push('  dtype: ' + n), u.push('  rank: ' + a), u.push('  shape: [' + e + ']'), u.push('  values:')),
						u.push(
							s
								.map(function (t) {
									return '    ' + t;
		...
		(wt.prototype.batchNormalization = function (t, e, n, r, o) {
			return void 0 === n && (n = 0.001), yt('tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon'), this.batchNorm(t, e, o, r, n);
		}),
		(wt.prototype.batchNorm = function (t, e, n, r, o) {
			return void 0 === o && (o = 0.001), this.throwIfDisposed(), gt.batchNorm(this, t, e, n, r, o);
		}),
		...
		(wt.prototype.leakyRelu = function (t) {
			return void 0 === t && (t = 0.2), this.throwIfDisposed(), gt.leakyRelu(this, t);
		}),
		...
		(wt.prototype.localResponseNormalization = function (t, e, n, r) {
			return void 0 === t && (t = 5), void 0 === e && (e = 1), void 0 === n && (n = 1), void 0 === r && (r = 0.5), gt.localResponseNormalization(this, t, e, n, r);
		}),
	...
	var Ct,
		...
		Ft =
			(t(Mt, (kt = bt)),
			(Mt.prototype.assign = function (t) {
	...
	Object.defineProperty(Ft, Symbol.hasInstance, {
		...
		(Nt.R5 = 'R5'),
		(Nt.R6 = 'R6'),
		((Tt = Et = Et || {}).float32 = 'float32'),
		(Tt.int32 = 'int32'),
		(Tt.bool = 'int32'),
		(Tt.complex64 = 'complex64'),
		((At = _t = _t || {}).float32 = 'float32'),
		(At.int32 = 'int32'),
		(At.bool = 'bool'),
		(At.complex64 = 'complex64'),
		((Dt = It = It || {}).float32 = 'float32'),
		(Dt.int32 = 'float32'),
		(Dt.bool = 'float32'),
		(Dt.complex64 = 'complex64'),
		((St = Rt = Rt || {}).float32 = 'complex64'),
		(St.int32 = 'complex64'),
		(St.bool = 'complex64'),
		...
		Ht =
			...
			(qt.prototype.initializeBackend = function (e) {
				...
				try {
					...
					return console.warn('Initialization of backend ' + e + ' failed'), console.warn(n.stack || n.message), { success: !1, asyncInit: !1 };
				}
			}),
			...
			(qt.prototype.incRef = function (t, e) {
				...
				if ((this.state.numTensors++, 'string' === t.dtype && this.state.numStringTensors++, 0 === n)) {
					...
					var r = 0;
					'complex64' !== t.dtype && 'string' !== t.dtype && (r = t.size * U(t.dtype)), this.state.tensorInfo.set(t.dataId, { backend: e || this.backend, dtype: t.dtype, shape: t.shape, bytes: r, refCount: 0 }), (this.state.numBytes += r);
				}
					...
					function () {
						...
						return (
							...
							e.runKernelFunc(
								function (t, e) {
									return (
										P((i = r.apply(void 0, a.concat([e]))).value instanceof bt, function () {
		...
		t in ne ||
			(ne[t] = (function (e) {
				...
				return (
					...
					1 === e ? t.getContext('webgl', re) || t.getContext('experimental-webgl', re) : t.getContext('webgl2', re)
				);
			})(t));
		var e = ne[t];
	...
	var Cn = wn({
			complex_: function (t, e) {
				var n = cn(t, 'real', 'complex'),
					r = cn(e, 'imag', 'complex');
				return (
					x(n.shape, r.shape, 'real and imag shapes, ' + n.shape + ' and ' + r.shape + ', must match in call to tf.complex().'),
					Kt.runKernelFunc(
						function (t) {
	...
	var nr = er.alea,
		rr =
			((ur.prototype.nextValue = function () {
			...
			ur),
		or =
			((sr.prototype.nextValue = function () {
				for (var t, e, n, r, o, i; ; ) {
					for (; (r = this.randn.nextValue()), (i = 1 + this.c * r) <= 0; );
					if (((i *= i * i), (e = 1 - 0.331 * (t = r * r) * t), (n = 0.5 * t + this.d * (1 - i + Math.log(i))), (o = this.randu()) < e || Math.log(o) < n)) break;
				}
	...
	var fr = wn({
		...
		_r = wn({
			pad2d_: function (t, e, n) {
				return (
					void 0 === n && (n = 0),
					P(2 === e.length && 2 === e[0].length && 2 === e[1].length, function () {
		...
		Ir = wn({
			pad3d_: function (t, e, n) {
				return (
					void 0 === n && (n = 0),
					P(3 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length, function () {
						return 'Invalid number of paddings. Must be length of 2 each.';
					}),
					Cr(t, e, n)
				);
		...
		Rr = wn({
			pad4d_: function (t, e, n) {
				return (
					void 0 === n && (n = 0),
					P(4 === e.length && 2 === e[0].length && 2 === e[1].length && 2 === e[2].length && 2 === e[3].length, function () {
						return 'Invalid number of paddings. Must be length of 2 each.';
					}),
					Cr(t, e, n)
				);
					...
					function (i, t) {
						...
						return {
							x: function () {
								...
								else if (2 === a.rank) for (e = 0; e < s[0]; ++e) for (var n = 0; n < s[1]; ++n) t = t.add(i.slice([e * a.shape[0], n * a.shape[1]], [a.shape[0], a.shape[1]]));
								else if (3 === a.rank) for (e = 0; e < s[0]; ++e) for (n = 0; n < s[1]; ++n) for (var r = 0; r < s[2]; ++r) t = t.add(i.slice([e * a.shape[0], n * a.shape[1], r * a.shape[2]], [a.shape[0], a.shape[1], a.shape[2]]));
								else {
	...
	function Xr(t, e, n) {
		...
		var u = o < 1 ? 1 : o;
		return { sliceRank: o, numUpdates: L(e.shape) / u, sliceSize: a, strides: Y(n.slice(0, o)).concat([1]), outputSize: L(n) };
	}
	...
	function Wo(t, e, n, r, o, i, a, s) {
		...
		var x,
			...
			R,
			k = l.length;
		return s && (l.fill(0, k), h.fill(0, k)), { selectedIndices: Sn(l, 'int32'), selectedScores: Sn(h, 'float32'), numValidOutputs: kn(k, 'int32') };
	}
	function zo(t, e, n) {
	...
	function Ho(t, e, n, r) {
		for (var o = e[e.length - 1], i = [t.length / o, o], a = i[0], s = i[1], u = N(n, a * r), c = N('int32', a * r), l = 0; l < a; l++) {
			for (var h = l * s, f = t.subarray(h, h + s), p = [], d = 0; d < f.length; d++) p.push({ value: f[d], index: d });
			p.sort(function (t, e) {
								...
								(r += n
									? (function (t, e) {
											var n,
												...
												u = vo(t.shapeInfo.logicalShape, e.logicalShape),
												c = oi(s),
												l = s - a,
												h = ['x', 'y', 'z', 'w', 'u', 'v'];
											n =
									...
									: (function (t, e) {
											...
											var c = oi(u),
												l = vo(t.shapeInfo.logicalShape, e.logicalShape),
												h = u - s,
												f = ['x', 'y', 'z', 'w', 'u', 'v'];
											return (
												'\n    float ' +
	...
	function si(t, e, n, r) {
		...
		var p = ['x', 'y', 'z', 'w', 'u', 'v'].slice(0, s),
			...
			m = $o('sourceLocR', s - 1).concat('inIdx.r'),
			g = $o('sourceLocG', s - 1).concat('inIdx.g'),
			y = $o('sourceLocB', s - 1).concat('inIdx.b'),
			x = $o('sourceLocA', s - 1).concat('inIdx.a'),
	...
	var yi = 'return a + b;',
		...
		Ei =
			((Ri.prototype.getCustomSetupFunc = function (n, r) {
				var o = this;
				return function (t, e) {
			...
			Ri),
		_i =
			((Ii.prototype.getCustomSetupFunc = function (n, r) {
				var o = this;
				return function (t, e) {
					null == o.minLoc && ((o.minLoc = t.getUniformLocationNoThrow(e, 'minVal')), (o.maxLoc = t.getUniformLocationNoThrow(e, 'maxVal'))), t.gl.uniform1f(o.minLoc, n), t.gl.uniform1f(o.maxLoc, r);
				};
	...
	var $i =
			((Zi.prototype.getHeightCoordString = function () {
			...
			Zi),
		Ji =
			((Qi.prototype.getCustomSetupFunc = function (n) {
				var r = this;
				return function (t, e) {
	...
	function ha(t, e, n, r, o, i, a) {
		...
		le(t, e, function () {
			...
			(c = i instanceof Uint8Array ? ((s = new Uint8Array(r * o * 4)), (u = t.UNSIGNED_BYTE), t.RGBA) : ((s = new Float32Array(r * o * 4)), (u = t.FLOAT), a.internalFormatPackedFloat)),
			s.set(i),
			le(t, e, function () {
	...
	function ma(t, e, n, r, o, i, a, s) {
		var u,
			c = t,
			l = new Float32Array((u = ue(i, a))[0] * u[1] * 4);
		...
		xa =
			...
			(ba.prototype.deleteMatrixTexture = function (t) {
				...
				this.throwIfDisposed(),
					...
					le(this.gl, this.debug, function () {
			...
			(ba.prototype.createProgram = function (t) {
				...
				return (
					...
					be(e, this.debug, o),
					this.debug && we(e, this.debug, o),
					this.vertexAttrsAreBound || (this.setProgram(o), (this.vertexAttrsAreBound = la(e, this.debug, this.program, this.vertexBuffer))),
					o
				);
			}),
			...
			(ba.prototype.setProgram = function (t) {
				...
				this.throwIfDisposed(),
					(this.program = t),
					null != this.program && this.debug && we(this.gl, this.debug, this.program),
					le(this.gl, this.debug, function () {
			...
			(ba.prototype.setOutputMatrixTextureDriver = function (t, e, n) {
				this.throwIfDisposed();
				var r = this.gl;
				Ne(r, this.debug, t, this.framebuffer),
					this.debug && Me(r),
	...
	function ba(t) {
		...
		if (1 === _().getNumber('WEBGL_VERSION')) {
			if (((this.textureFloatExtension = pe(this.gl, this.debug, 'OES_texture_float')), Ke(this.gl, 'OES_texture_half_float'))) this.textureHalfFloatExtension = pe(this.gl, this.debug, 'OES_texture_half_float');
			...
			if (((this.colorBufferFloatExtension = this.gl.getExtension(n)), Ke(this.gl, 'EXT_color_buffer_half_float'))) this.colorBufferHalfFloatExtension = pe(this.gl, this.debug, 'EXT_color_buffer_half_float');
		...
		} else if (((n = 'EXT_color_buffer_float'), Ke(this.gl, n))) this.colorBufferFloatExtension = this.gl.getExtension(n);
		else {
	...
	function Ea(t, e, n, r, o) {
		...
		(i = 0.5 === o ? 'inversesqrt(' + u + ')' : 1 === o ? '1.0/(' + u + ')' : 'exp(log(' + u + ') * float(-' + o + '));'), (this.userCode = '\n      void main() {\n        ivec4 coords = getOutputCoords();\n        int b = coords[0];\n        int r = coords[1];\n        int c = coords[2];\n        int d = coords[3];\n        float x = getX(b, r, c, d);\n        float sum = 0.0;\n        for (int j = -' + a + '; j <= ' + a + '; j++) {\n          int idx = d + j;\n          if (idx >= 0 && idx <=  ' + s + ') {\n            float z = getX(b, r, c, idx);\n            sum += z * z;\n          }\n        }\n        float val = x * ' + i + ';\n        setOutput(val);\n      }\n    ');
	}
	...
	var Ta =
		((Na.prototype.getCustomSetupFunc = function (n) {
			var r = this;
			return function (t, e) {
	...
	function Ma(n, t, e) {
		...
		for (
			var r = n.length,
				...
				h = [o + ' rc = outputLoc;', s[r - 1] + ' += 1;\n       if(' + c + ') {\n      ', 1 === r ? '' : '}\n       rc = outputLoc;\n       ' + s[r - 2] + ' += 1;\n       if(' + s[r - 2] + ' < ' + this.outputShape[r - 2] + ') {', 1 === r ? '' : '  ' + s[r - 1] + ' += 1;\n         if(' + c + ') {'],
				f = 1 === r ? 'rc < start || rc >= end' : 'any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))',
				p = '',
				d = 0,
				v = 1 === r ? 2 : 4;
			d < v;
	...
	var Ya =
			((Ja.prototype.getCustomSetupFunc = function (n) {
				var r = this;
	...
	var Za =
			((ns.prototype.getCustomSetupFunc = function (n) {
				var r = this;
				if (n.length !== this.rank) throw Error('The rank (' + this.rank + ') of the program must match the length of start (' + n.length + ')');
				return function (t, e) {
					(null == r.startLoc && ((r.startLoc = t.getUniformLocationNoThrow(e, 'start')), null == r.startLoc)) || t.gl.uniform1iv(r.startLoc, n);
			...
			ns),
		ts =
			((es.prototype.acquireTexture = function (t, e, n) {
				var r,
					o = rs(e, n),
					i = os(t, o, n);
	...
	function ns(t) {
		...
		var e = oi(this.rank),
			n = $o('coords', this.rank),
			r = $o('sourceLoc', this.rank),
	...
	var hs = 1.7580993408473768,
		fs = 1.0507009873554805,
		ps = 'if (isnan(x)) return x;',
		ds = 'return abs(x);',
		vs = ps + '\n  return (x < 0.0) ? 0.0 : x;\n',
		ms = ps + '\n  return (x < 0.0) ? 0.0 : min(6.0, x);\n',
		gs = 'return (x >= 0.0) ? x : (exp(x) - 1.0);',
		ys = 'return -x;',
		xs = 'return ceil(x);',
		bs = 'return floor(x);',
		ws = 'return exp(x);',
	...
	var Ds,
		As =
			(t(Ts, (Ds = lo)),
			(Ts.prototype.numDataIds = function () {
					...
					return R(this, function (t) {
						switch (t.label) {
							case 0:
								...
								if (((n = this.texData.get(E)), (r = n.values), (o = n.shape), (i = n.slice), (a = n.dtype), (s = n.complexTensors), (u = n.isPacked), null != i)) return (c = u ? new cs(o, Es) : new us(o, Es)), (l = this.runWebGLProgram(c, [{ dataId: E, shape: o, dtype: a }], a)), (h = this.read(l.dataId)), this.disposeData(l.dataId), [2, h];
							...
							case 5:
								return (
									null != p && this.disposeData(p.dataId),
									...
									this.pendingDisposal.has(E) && (this.pendingDisposal.delete(E), this.disposeData(E), this.pendingDeletes--),
									[2, b]
								);
						}
					});
			...
			(Ts.prototype.getValuesFromTexture = function (t) {
				...
				var l = _().getBool('WEBGL_PACK') && !0 === i,
					h = l ? ze(r) : r,
					f = l ? new qi(h) : new Hi(h),
					p = this.runWebGLProgram(f, [{ shape: h, dtype: o, dataId: t }], 'float32'),
						...
						switch (t.label) {
							case 0:
								return (
									...
									(a = { uploadWaitMs: this.uploadWaitMs, downloadWaitMs: this.downloadWaitMs, kernelMs: null, wallMs: null }),
			...
			(Ts.prototype.startTimer = function () {
				return 0 < _().getNumber('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE') ? this.gpgpu.beginQuery() : { startMs: tt(), endMs: null };
			}),
			...
			(Ts.prototype.slice = function (t, e, n) {
				...
				var i = _().getBool('WEBGL_PACK_ARRAY_OPERATIONS') ? new Za(n) : new Ya(n),
			...
			(Ts.prototype.batchMatMul = function (t, e, n, r) {
				...
				var h = Pt(t.dtype, e.dtype),
					f = new Sa(t.shape, [s, o, i], n, r);
			...
			(Ts.prototype.fusedBatchMatMul = function (t) {
				var e = t.a,
					...
					l = e.shape[0],
					h = Pt(e.dtype, n.dtype),
					f = null != i,
					p = null != s,
					d = a ? Ss(a, !0) : null,
					v = new Sa(e.shape, [l, u, c], r, o, f, d, p),
					m = [e, n];
			...
			(Ts.prototype.reduce = function (t, e, n) {
				var r = t.shape[0],
					o = t.shape[1],
					i = qr(o),
					a = new Ba({ windowSize: i, inSize: o, batchSize: r }, e),
			...
			(Ts.prototype.argReduce = function (t, e, n) {
				...
				var i = qr(o),
					a = new Xo({ windowSize: i, inSize: o, batchSize: r }, e, null == n),
					s = [t];
				null != n && s.push(n);
			...
			(Ts.prototype.segOpCompute = function (t, e, n, r, o) {
				var i = t.shape[0],
					...
					u = new Ka({ windowSize: s, inSize: a, batchSize: i, numSegments: o }, e),
			...
			(Ts.prototype.clip = function (t, e, n) {
				var r,
					o = (r = _().getBool('WEBGL_PACK_CLIP') ? new _i(t.shape) : new Ei(t.shape)).getCustomSetupFunc(e, n);
			...
			(Ts.prototype.conv2dByMatMul = function (t, e, n, r, o, i) {
				...
				return (
					...
					(s.shape = x),
					(C.shape = n.outShape),
					Kt.makeTensorFromDataId(w.dataId, n.outShape, w.dtype)
				);
			}),
			(Ts.prototype.conv2dWithIm2Row = function (t, e, n, r, o, i) {
				var a = n.filterWidth,
					...
					v = t.squeeze([0]),
					m = e.reshape([1, f, -1]),
					g = new Ca(d, v.shape, n),
					y = this.compileAndRun(g, [v]).reshape([1, d[0], d[1]]),
					x = null != r,
					b = null != i,
					w = o ? Ss(o, !0) : null,
					C = new Sa(y.shape, [1, p, n.outChannels], !0, !1, x, w, b),
					E = [y, m];
			...
			(Ts.prototype.scatterND = function (t, e, n) {
				...
				var f = kn(0),
					p = new ja(i, o, l.rank, h.rank, s, c);
			...
			(Ts.prototype.fftImpl = function (t, e) {
				var n = this.texData.get(t.dataId),
					r = new Xi('return real * expR - imag * expI;', t.shape, e),
			...
			(Ts.prototype.packedReshape = function (t, e) {
				var n = [Le(t.shape)].concat(We(t.shape)),
			...
			(Ts.prototype.decode = function (t) {
				var e,
					...
					i = n.dtype,
					a = ze(o);
				return (e = r ? new Vi(a) : new Ui(a)), { dtype: i, shape: o, dataId: this.runWebGLProgram(e, [{ shape: a, dtype: i, dataId: t }], i, null, !0).dataId };
			}),
			(Ts.prototype.runWebGLProgram = function (o, t, e, n, r) {
				...
				var c = [],
					l = t.map(function (t) {
						...
						else if (e.isPacked && !Ge(e.shape, t.shape)) {
							var n = t,
								r = t.shape;
				...
				var h,
					f = { shape: a.shape, texData: s, isUniform: !1 },
					p = (function (t, e, n) {
						var r = '';
					...
					d = this.getAndSaveBinary(p, function () {
						return (function (t, r, e, n) {
							var o = r.userCode,
								i = e.map(function (t, e) {
									var n = { logicalShape: t.shape, texShape: t.isUniform ? null : t.texData.texShape, isUniform: t.isUniform, isPacked: !t.isUniform && t.texData.isPacked, flatOffset: null };
									return null != t.texData && null != t.texData.slice && 0 < t.texData.slice.flatOffset && (n.flatOffset = t.texData.slice.flatOffset), { name: r.variableNames[e], shapeInfo: n };
								}),
								a = i.map(function (t) {
									return t.shapeInfo;
								}),
								s = { logicalShape: n.shape, texShape: n.texData.texShape, isUniform: !1, isPacked: n.texData.isPacked, flatOffset: null },
								u = ei(i, s, o, r.packedInputs),
								c = t.createProgram(u),
								l = null,
							...
							return { program: r, source: u, webGLProgram: c, uniformLocations: f, inShapeInfos: a, outShapeInfo: s, infLoc: l, nanLoc: h };
						})(i.gpgpu, o, l, f);
					}),
				...
				if (
					...
					(function (a, s, t, e, n) {
						...
						e.texData.isPacked ? a.setOutputPackedMatrixTexture(r, o[0], o[1]) : a.setOutputMatrixTexture(r, o[0], o[1]),
							...
							1 === _().getNumber('WEBGL_VERSION') && null !== s.infLoc && a.gl.uniform1f(s.infLoc, 1 / 0),
					...
					v && ((h = this.endTimer(h)), this.activeTimers.push({ name: o.constructor.name, query: this.getQueryTime(h) })),
	...
	var Ns = wn({
		...
		Fs = 'SquaredDifference',
		Ms = wn({
			squaredDifference_: function (t, e) {
				var n,
					r = cn(t, 'a', 'squaredDifference'),
					o = cn(e, 'b', 'squaredDifference');
	...
	function vu(t, e, n, r, o, i) {
		var a,
			s,
			u = cn(t, 'x', 'batchNorm'),
			c = cn(e, 'mean', 'batchNorm'),
			l = cn(n, 'variance', 'batchNorm');
		return (
			null != o && (a = cn(o, 'scale', 'batchNorm')),
			null != r && (s = cn(r, 'offset', 'batchNorm')),
			P(2 === u.rank, function () {
	...
	function yu(t, e, n, r, o, v) {
		...
		var i,
			...
			m,
			s = cn(t, 'x', 'batchNorm'),
			u = cn(e, 'mean', 'batchNorm'),
			c = cn(n, 'variance', 'batchNorm');
		null != o && (i = cn(o, 'scale', 'batchNorm')),
			null != r && (a = cn(r, 'offset', 'batchNorm')),
		...
		return Kt.runKernelFunc(
			...
			function (n, t) {
				...
				var h = r.sub(o),
					f = n.mul(s),
					p = nu(i.add(kn(v))),
					d = p.mul(p).mul(p).mul(kn(-0.5));
				return {
					x: function () {
						return 1 === o.rank
							? n
									.mul(Or(p.as4D(1, 1, 1, o.shape[0]), c))
									.mul(s)
									.reshape(r.shape)
							: n.mul(p).mul(s).reshape(r.shape);
					},
					mean: function () {
	...
	var Cu = wn({
			batchNormalization2d_: function (t, e, n, r, o, i) {
				return void 0 === r && (r = 0.001), bu(), vu(t, e, n, i, o, r);
			},
		}),
		Eu = wn({
			batchNormalization3d_: function (t, e, n, r, o, i) {
				return void 0 === r && (r = 0.001), bu(), mu(t, e, n, i, o, r);
			},
		}),
		_u = wn({
			batchNormalization4d_: function (t, e, n, r, o, i) {
				return void 0 === r && (r = 0.001), bu(), gu(t, e, n, i, o, r);
			},
		}),
		Iu = wn({
			batchNormalization_: function (t, e, n, r, o, i) {
				return void 0 === r && (r = 0.001), bu(), yu(t, e, n, i, o, r);
			},
		}),
		Ru = wn({ batchNorm_: yu }),
		ku = wn({ batchNorm2d_: vu }),
		Su = wn({ batchNorm3d_: mu }),
		Du = wn({ batchNorm4d_: gu }),
		Au = wn({
			logicalAnd_: function (t, e) {
				var n = cn(t, 'a', 'logicalAnd', 'bool'),
					r = cn(e, 'b', 'logicalAnd', 'bool');
				return (
					go(n.shape, r.shape),
					Kt.runKernelFunc(
						function (t) {
		...
		Nu = wn({
			logicalOr_: function (t, e) {
				var n = cn(t, 'a', 'logicalOr', 'bool'),
					r = cn(e, 'b', 'logicalOr', 'bool');
				return (
					go(n.shape, r.shape),
					Kt.runKernelFunc(
						function (t) {
		...
		Fu = wn({
			logicalXor_: function (t, e) {
				var n = cn(t, 'a', 'logicalXor', 'bool'),
					r = cn(e, 'b', 'logicalXor', 'bool');
		...
		Hu = wn({
			maximumStrict_: function (t, e) {
				var n = cn(t, 'a', 'maximumStrict'),
					r = cn(e, 'b', 'maximumStrict');
		...
		ju = wn({
			minimumStrict_: function (t, e) {
				var n = cn(t, 'a', 'minimumStrict'),
					r = cn(e, 'b', 'minimumStrict');
				...
				return Kt.runKernelFunc(
					...
					function (o, t) {
						...
						return {
							a: function () {
								var t = a.toFloat(),
									e = o.mul(t.mul(i.pow(t.sub(kn(1))))),
									n = mo(i.shape, u);
								return 0 < n.length && (e = e.sum(n)), e.reshape(i.shape);
							},
							b: function () {
								var t = i.greater(0),
									e = i.log().where(t, Un(i)),
									n = o.mul(s.mul(e)),
									r = mo(a.shape, u);
		...
		Zu = wn({
			squaredDifferenceStrict_: function (t, e) {
				var n = cn(t, 'a', 'squaredDifferenceStrict'),
					r = cn(e, 'b', 'squaredDifferenceStrict');
		...
		rc = wn({
			equalStrict_: function (t, e) {
				var n = cn(t, 'a', 'equalStrict'),
					r = cn(e, 'b', 'equalStrict');
		...
		ic = wn({
			greaterEqual_: function (t, e) {
				var n,
					r = cn(t, 'a', 'greaterEqual'),
					o = cn(e, 'b', 'greaterEqual');
				return (
					(n = Lt(r, o)),
					(r = n[0]),
					(o = n[1]),
		...
		ac = wn({
			greaterEqualStrict_: function (t, e) {
				var n = cn(t, 'a', 'greaterEqualStrict'),
					r = cn(e, 'b', 'greaterEqualStrict');
				return x(n.shape, r.shape, 'Error in greaterEqualStrict: '), n.greaterEqual(r);
			},
		}),
		sc = wn({
			greaterStrict_: function (t, e) {
				var n = cn(t, 'a', 'greaterStrict'),
					r = cn(e, 'b', 'greaterStrict');
		...
		pc = wn({
			notEqualStrict_: function (t, e) {
				var n = cn(t, 'a', 'notEqualStrict'),
					r = cn(e, 'b', 'notEqualStrict');
		...
		return y(this, void 0, void 0, function () {
			...
			return R(this, function (t) {
				switch (t.label) {
					case 0:
						for (
							e = cn(d, 'tensor', 'boolMask'),
								n = cn(v, 'mask', 'boolMask', 'bool'),
								r = null == m ? 0 : m,
								o = n.rank,
								i = e.shape,
								P(0 < o, function () {
								...
								x(i.slice(r, r + o), n.shape, "mask's shape must match the first K dimensions of tensor's shape,"),
								a = 1,
								s = r;
							s < r + o;
							s++
	...
	var gc = wn({
		...
		yc = wn({
			unsortedSegmentSum_: function (t, e, r) {
				var o = cn(t, 'x', 'unsortedSegmentSum'),
					i = cn(e, 'segmentIds', 'unsortedSegmentSum', 'int32');
				return (
					P(B(r), function () {
	...
	function xc(t, e, r, o, i, a, s) {
		...
		var n = t,
			u = e,
			c = !1;
		3 === e.rank && ((c = !0), (u = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])), (n = [1, t[0], t[1], t[2]])),
	...
	function bc(t) {
		var e,
			n = 'number' == typeof (e = t) ? [e, e, e] : 2 === e.length ? [e[0], e[1], 1] : e,
			r = n[0],
			o = n[1],
			i = n[2];
		return 1 === r && 1 === o && 1 === i;
	...
	var Cc = wn({
		...
		Ec = wn({
			conv2d_: function (t, e, i, a, s, u, n) {
				...
				var r = cn(t, 'x', 'conv2d'),
					o = cn(e, 'filter', 'conv2d'),
					c = r,
					l = !1;
				3 === r.rank && ((l = !0), (c = r.as4D(1, r.shape[0], r.shape[1], r.shape[2]))),
					P(4 === c.rank, function () {
				...
				var f = Do(s),
					p = bo(c.shape, o.shape, i, u, a, n, !1, f),
					d = [o, c],
					v = Kt.runKernelFunc(
						function (t, e) {
		...
		_c = wn({
			conv3d_: function (t, e, o, i, n, a) {
				...
				var h = wo(c.shape, u.shape, o, a, i),
					f = Kt.runKernelFunc(
						function (t, e) {
		...
		Rc = wn({ conv2dDerInput_: xc }),
		kc = wn({
			depthwiseConv2d_: function (t, e, n, r, o, i, a) {
				void 0 === i && (i = [1, 1]);
				var s = cn(t, 'x', 'depthwiseConv2d'),
					u = cn(e, 'filter', 'depthwiseConv2d'),
					c = s,
					l = !1;
				...
				var h = bo(c.shape, u.shape, n, i, r, a, !0),
					f = [c, u],
					p = Kt.runKernelFunc(
						function (t, e) {
		...
		Ac = wn({
			separableConv2d_: function (t, e, n, r, o, i, a) {
				...
				var s = cn(t, 'x', 'separableConv2d'),
					...
					c = cn(n, 'pointwiseFilter', 'separableConv2d'),
					l = s,
					h = !1;
		...
		Oc = wn({
			outerProduct_: function (t, e) {
				var n = cn(t, 'v1', 'outerProduct'),
					r = cn(e, 'v2', 'outerProduct');
				return (
	...
	function Uc(t, r, o, i, a, e) {
		var n = cn(t, 'x', 'maxPool'),
			s = n,
			u = !1;
		3 === n.rank && ((u = !0), (s = n.as4D(1, n.shape[0], n.shape[1], n.shape[2]))),
			null == i && (i = [1, 1]),
			P(4 === s.rank, function () {
					...
					return {
						x: function () {
							return (function (t, e, n, r, o, i, a) {
								var s = cn(h, 'dy', 'maxPoolBackprop'),
									u = cn(e, 'input', 'maxPoolBackprop'),
				...
				return {
					x: function () {
						return (function (t, e, n, r, o, i) {
							var a = cn(p, 'dy', 'avgPoolBackprop'),
								s = cn(e, 'input', 'avgPoolBackprop');
	...
	var Gc = wn({
		...
		jc = wn({
			maxPool3d_: function (t, r, o, i, a, e, s) {
				void 0 === e && (e = 'NDHWC');
				var n = cn(t, 'x', 'maxPool3d'),
					u = n,
					c = !1;
				4 === n.rank && ((c = !0), (u = n.as5D(1, n.shape[0], n.shape[1], n.shape[2], n.shape[3]))),
					null == s && (s = [1, 1, 1]),
					P(5 === u.rank, function () {
							...
							return {
								x: function () {
									return (function (t, e, n, r, o, i, a, s) {
										var u = cn(g, 'dy', 'maxPool3dBackprop'),
											c = cn(e, 'input', 'maxPool3dBackprop'),
											l = cn(n, 'output', 'maxPool3dBackprop'),
											h = u,
											f = c,
											p = l,
											d = !1;
										4 === c.rank && ((d = !0), (h = u.as5D(1, u.shape[0], u.shape[1], u.shape[2], u.shape[3])), (f = c.as5D(1, c.shape[0], c.shape[1], c.shape[2], c.shape[3])), (p = l.as5D(1, l.shape[0], l.shape[1], l.shape[2], l.shape[3]))),
											P(5 === h.rank, function () {
		...
		Kc = wn({
			avgPool3d_: function (t, e, n, r, o, i, a) {
				void 0 === i && (i = 'NDHWC');
				var s = cn(t, 'x', 'avgPool3d', 'float32'),
					u = s,
					c = !1;
				4 === s.rank && ((c = !0), (u = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3]))),
					null == a && (a = [1, 1, 1]),
					P(5 === u.rank, function () {
					...
					h = Kt.runKernelFunc(
						...
						function (d) {
							return {
								x: function () {
									return (function (t, e, n, r, o, i, a) {
										var s = cn(d, 'dy', 'avgPool3dBackprop'),
											u = cn(e, 'input', 'avgPool3dBackprop'),
											c = s,
											l = u,
											h = !1;
	...
	function Zc(e, n, r, t, o) {
		return (
			n.rank < r.rank && (n = n.reshape(dn(n.shape, t))),
			e.rank < r.rank && (e = e.reshape(dn(e.shape, t))),
			{
				x: function () {
	...
	var tl = wn({
			all_: function (t, e, n) {
				...
				var r = cn(t, 'x', 'all', 'bool'),
					o = D(e, r.shape),
					i = o,
					a = mn(i, r.rank);
				null != a && ((r = r.transpose(a)), (i = yn(i.length, r.rank)));
				var s = Kt.runKernelFunc(
					function (t) {
						return t.all(r, i);
					},
					{ $x: r }
		...
		ul = wn({
			moments_: function (t, e, n) {
				void 0 === e && (e = null), void 0 === n && (n = !1);
				var r = D(e, (t = cn(t, 'x', 'moments')).shape),
					o = t.mean(r, n),
					i = o.shape;
				n || (i = dn(o.shape, r));
				...
				return Kt.runKernelFunc(
					...
					function (n, t) {
						...
						return {
							...
							alpha: function () {
								var t = Mu(i, Un(n), n.mul(r)),
									e = mo(o.shape, n.shape);
								return 0 < e.length && (t = t.sum(e)), t.reshape(o.shape);
							},
						};
					},
		...
		bl = wn({
			basicLSTMCell_: function (t, e, n, r, o, i) {
				var a = cn(t, 'forgetBias', 'basicLSTMCell'),
					s = cn(e, 'lstmKernel', 'basicLSTMCell'),
					u = cn(n, 'lstmBias', 'basicLSTMCell'),
					c = cn(r, 'data', 'basicLSTMCell'),
					l = cn(o, 'c', 'basicLSTMCell'),
					h = cn(i, 'h', 'basicLSTMCell'),
		...
		Cl = wn({
			movingAverage_: function (t, e, n, r, o) {
				void 0 === o && (o = !0);
				var i = cn(t, 'v', 'movingAverage'),
					a = cn(e, 'x', 'movingAverage'),
					s = cn(n, 'decay', 'movingAverage');
				Wt(i, a),
					P(A(i.shape, a.shape), function () {
		...
		Il = wn({
			scatterND_: function (t, e, n) {
				var r = cn(t, 'indices', 'scatterND', 'int32'),
					o = cn(e, 'updates', 'scatterND');
				return (
					Kr(o, r, n),
					Kt.runKernelFunc(
						function (t) {
		...
		Al = Object.freeze({ fft: Rl, ifft: kl, rfft: Sl, irfft: Dl }),
		Tl = wn({
			sparseToDense_: function (t, e, n, r) {
				void 0 === r && (r = 0);
				var o = cn(t, 'sparseIndices', 'sparseToDense', 'int32'),
					i = cn(e, 'sparseValues', 'sparseToDense'),
		...
		Nl = wn({
			gatherND_: function (t, e) {
				var n = cn(e, 'indices', 'gatherND', 'int32'),
					r = cn(t, 'x', 'gatherND');
				return Kt.runKernelFunc(
					function (t) {
		...
		Ml = wn({
			dropout_: function (t, e, n, r) {
				...
				var i = (function (t, e) {
					...
					a = 1 - e,
					s = Ar(i, 0, 1, 'float32', r).add(a).floor().div(a);
				return o.mul(s);
			},
		});
	function Ol(t, e, n) {
			...
			y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					switch (t.label) {
						case 0:
							return (
								(e = cn(v, 'predictions', 'inTopK')),
								(n = cn(m, 'targets', 'inTopK')),
								P(1 < e.rank, function () {
								...
								x(e.shape.slice(0, e.shape.length - 1), n.shape, "predictions's shape should be align with the targets' shape, except the last dimension."),
						...
						case 2:
							for (i = t.sent(), a = [o.length / r, r], u = a[1], c = N('bool', (s = a[0])), l = 0; l < s; l++) {
								for (h = l * u, f = o.subarray(h, h + u), p = [], d = 0; d < f.length; d++) p.push({ value: f[d], index: d });
								for (
									p.sort(function (t, e) {
										return e.value - t.value;
									}),
	...
	var Hl = wn({
			absoluteDifference_: function (t, e, n, r) {
				...
				var o = cn(t, 'labels', 'absoluteDifference'),
					i = cn(e, 'predictions', 'absoluteDifference'),
					a = null;
		...
		ql = wn({
			computeWeightedLoss_: function (t, e, n) {
				...
				var r = cn(t, 'losses', 'computeWeightedLoss'),
					o = null;
		...
		jl = wn({
			cosineDistance_: function (t, e, n, r, o) {
				...
				var i = cn(t, 'labels', 'cosineDistance'),
					a = cn(e, 'predictions', 'cosineDistance'),
					s = null;
		...
		Kl = wn({
			hingeLoss_: function (t, e, n, r) {
				void 0 === r && (r = Bl.SUM_BY_NONZERO_WEIGHTS);
				var o = cn(t, 'labels', 'hingeLoss'),
					i = cn(e, 'predictions', 'hingeLoss'),
					a = null;
		...
		Xl = wn({
			huberLoss_: function (t, e, n, r, o) {
				...
				var u = kn(r),
					...
					l = qu(c, u),
					h = c.sub(l),
					f = kn(0.5).mul(l.square()).add(u.mul(h));
				return ql(f, s, o);
			},
		}),
		Yl = wn({
			logLoss_: function (t, e, n, r, o) {
				...
				var i = cn(t, 'labels', 'logLoss'),
					a = cn(e, 'predictions', 'logLoss'),
					s = null;
		...
		$l = wn({
			meanSquaredError_: function (t, e, n, r) {
				void 0 === r && (r = Bl.SUM_BY_NONZERO_WEIGHTS);
				var o = cn(t, 'labels', 'meanSquaredError'),
					i = cn(e, 'predictions', 'meanSquaredError'),
					a = null;
		...
		Jl = wn({
			sigmoidCrossEntropy_: function (t, e, n, r, o) {
				...
				var s = cn(t, 'multiClassLabels', 'sigmoidCrossEntropy'),
					i = cn(e, 'logits', 'sigmoidCrossEntropy'),
					a = null;
		...
		Ql = wn({
			softmaxCrossEntropy_: function (t, e, n, r, o) {
				void 0 === r && (r = 0), void 0 === o && (o = Bl.SUM_BY_NONZERO_WEIGHTS);
				var i = cn(t, 'onehotLabels', 'softmaxCrossEntropy'),
					a = cn(e, 'logits', 'softmaxCrossEntropy'),
					s = null;
	...
	var eh = wn({
			bandPart_: function (t, e, n) {
				...
				e < 0 && (e = a), n < 0 && (n = s);
				var u = Wn(0, a, 1, 'int32').reshape([-1, 1]),
					c = Wn(0, s, 1, 'int32'),
					l = tc(u, c),
					h = Au(l.lessEqual(kn(+e, 'int32')), l.greaterEqual(kn(-n, 'int32'))),
					f = Pn([a, s], r.dtype);
				return Mr(
					Br(r.reshape([-1, a, s])).map(function (t) {
						return Mu(h, t, f);
					})
				).reshape(o);
			},
		...
		nh = wn({
			gramSchmidt_: function (e) {
				...
				if (Array.isArray(e)) {
					...
					(t = !0),
						(e = Kn(e, e.shape[0], 0).map(function (t) {
							return Fr(t, [0]);
						}));
		...
		rh = wn({
			qr_: function (t, o) {
				...
				var e = t.shape.slice(0, t.shape.length - 2).reduce(function (t, e) {
					...
					n = Br(t.reshape([e, t.shape[t.shape.length - 2], t.shape[t.shape.length - 1]]), 0),
					i = [],
					a = [];
				return (
					n.forEach(function (t) {
	...
	var lh = wn({
		...
		fh = wn({
			nonMaxSuppression_: function (t, e, n, r, o) {
				...
				var i = cn(t, 'boxes', 'nonMaxSuppression'),
					a = cn(e, 'scores', 'nonMaxSuppression'),
					s = ih(i, a, n, r, o);
		...
		ph = wn({
			nonMaxSuppressionWithScore_: function (t, e, n, r, o, i) {
				...
				var a = cn(t, 'boxes', 'nonMaxSuppression'),
					s = cn(e, 'scores', 'nonMaxSuppression'),
					u = ih(a, s, n, r, o, i),
		...
		dh = wn({
			cropAndResize_: function (t, e, n, r, o, i) {
				var a = cn(t, 'image', 'cropAndResize'),
					s = cn(e, 'boxes', 'cropAndResize', 'float32'),
		...
		vh = Object.freeze({
			...
			nonMaxSuppressionAsync: function (u, c, l, h, f) {
				return (
					void 0 === h && (h = 0.5),
					void 0 === f && (f = Number.NEGATIVE_INFINITY),
					y(this, void 0, void 0, function () {
						var e, n, r, o, i, a, s;
						return R(this, function (t) {
							switch (t.label) {
		...
		mh = wn({
			fusedMatMul_: function (t) {
				...
				var p = cn(n, 'a', 'fused matMul'),
					d = cn(r, 'b', 'fused matMul');
				(e = Lt(p, d)), (p = e[0]), (d = e[1]);
				var v = s ? p.shape[p.rank - 2] : p.shape[p.rank - 1],
				...
				var E,
					_,
					I = p.shape.slice(0, -2).concat([g, y]),
					R = s ? p.as3D(w, v, g) : p.as3D(w, g, v),
				...
				return Kt.runKernelFunc(
					function (t, e) {
						var n = t.fusedBatchMatMul({ a: R, b: k, transposeA: s, transposeB: u, bias: E, activation: l, preluActivationWeights: _ });
						return e([R, k, n]), n;
					},
					S,
					function (t, e) {
					...
					'_FusedMatMul',
					{ transposeA: s, transposeB: u, activation: l },
					D,
					[!0]
				).reshape(I);
			},
		...
		gh = wn({
			fusedConv2d_: function (t) {
				...
				var v = cn(e, 'x', 'conv2d'),
					m = cn(n, 'filter', 'conv2d'),
					g = v,
					y = !1;
				3 === v.rank && ((y = !0), (g = v.as4D(1, v.shape[0], v.shape[1], v.shape[2]))),
					P(4 === g.rank, function () {
				...
				var E = [m, g],
					_ = Kt.runKernelFunc(
						function (t, e) {
							var n = t.fusedConv2d({ input: g, filter: m, convInfo: w, bias: x, activation: f, preluActivationWeights: b });
							return e([m, g, n]), n;
						},
						C,
						function (t, e) {
		...
		yh = wn({
			fusedDepthwiseConv2d_: function (t) {
				...
				var v = cn(e, 'x', 'depthwiseConv2d'),
					m = cn(n, 'filter', 'depthwiseConv2d'),
					g = v,
					y = !1;
				3 === v.rank && ((y = !0), (g = v.as4D(1, v.shape[0], v.shape[1], v.shape[2]))),
					P(4 === g.rank, function () {
				...
				var x,
					b,
					w = bo(g.shape, m.shape, r, u, o, c, !0);
				...
				var E = [m, g],
					_ = Kt.runKernelFunc(
						function (t, e) {
							var n = t.fusedDepthwiseConv2D({ input: g, filter: m, convInfo: w, bias: x, activation: f, preluActivationWeights: b });
							return e([m, g, n]), n;
						},
						C,
						function (t, e) {
	...
	var Eh,
		_h =
			(t(Ih, (Eh = lo)),
			(Ih.prototype.write = function (t, e, n) {
			...
			(Ih.prototype.unsortedSegmentSum = function (t, e, n) {
				...
				for (i = 0; i < n; ++i) {
					var a = kn(i, 'int32'),
						s = nc(a, e).asType('float32').mul(t).sum(0);
					r.push(s);
				}
				return Mr(r);
			}),
			...
			(Ih.prototype.erf = function (t) {
				...
				for (var e = new Float32Array(t.size), n = this.readSync(t.dataId), r = 0; r < n.length; ++r) {
					var o = Math.sign(n[r]),
						i = Math.abs(n[r]),
						a = 1 / (1 + 0.3275911 * i);
					e[r] = o * (1 - ((((1.061405429 * a - 1.453152027) * a + 1.421413741) * a - 0.284496736) * a + 0.254829592) * a * Math.exp(-i * i));
				}
				return this.makeOutput(e, t.shape, 'float32');
			}),
				...
				for (var r = n.filterHeight, o = n.filterWidth, i = n.dilationHeight, a = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = 'channelsLast' === n.dataFormat, l = cr(n.outShape, t.dtype), h = t.strides[0], f = c ? t.strides[1] : t.strides[2], p = c ? t.strides[2] : 1, d = c ? 1 : t.strides[1], v = l.strides[0], m = c ? l.strides[1] : l.strides[2], g = c ? l.strides[2] : 1, y = c ? 1 : l.strides[1], x = this.readSync(t.dataId), b = this.readSync(e.dataId), w = l.values, C = 0; C < n.batchSize; ++C)
					for (var E = C * h, _ = C * v, I = 0; I < n.outHeight; ++I)
						for (var R = _ + I * m, k = I * n.strideHeight - u, S = 0; S < r; S++) {
							var D = k + S * i;
							if (!(D < 0 || D >= n.inHeight))
								for (var A = S * e.strides[0], T = E + D * f, N = 0; N < n.outWidth; ++N)
									for (var F = R + N * g, M = N * n.strideWidth - s, O = 0; O < o; O++) {
										var P = M + O * a;
										if (!(P < 0 || P >= n.inWidth))
											for (var B = T + P * p, L = A + O * e.strides[1], W = 0; W < n.inChannels; ++W) {
			...
			(Ih.prototype.conv3d = function (t, e, n) {
				for (var r = n.filterDepth, o = n.filterHeight, i = n.filterWidth, a = n.dilationDepth, s = n.dilationHeight, u = n.dilationWidth, c = n.padInfo.front, l = n.padInfo.left, h = n.padInfo.top, f = cr(n.outShape, t.dtype), p = this.readSync(t.dataId), d = this.readSync(e.dataId), v = f.values, m = 0; m < n.batchSize; ++m)
						...
						for (var b = y + x * f.strides[1], w = x * n.strideDepth - c, C = 0; C < r; C++) {
							...
							if (!(E < 0 || E >= n.inDepth))
								for (var _ = C * e.strides[0], I = g + E * t.strides[1], R = 0; R < n.outHeight; ++R)
									for (var k = b + R * f.strides[2], S = R * n.strideHeight - h, D = 0; D < o; D++) {
										var A = S + D * s;
										if (!(A < 0 || A >= n.inHeight))
			...
			(Ih.prototype.conv2dDerInput = function (t, e, n) {
				...
				for (var r = cr(n.inShape, 'float32'), o = r.values, i = this.readSync(t.dataId), a = this.readSync(e.dataId), s = e.strides, u = s[0], c = s[1], l = s[2], h = n.batchSize, f = n.filterHeight, p = n.filterWidth, d = n.inChannels, v = n.inHeight, m = n.inWidth, g = n.outChannels, y = n.outHeight, x = n.outWidth, b = n.strideHeight, w = n.strideWidth, C = n.dataFormat, E = f - 1 - n.padInfo.top, _ = p - 1 - n.padInfo.left, I = 'channelsLast' === C, R = r.strides[0], k = I ? r.strides[1] : r.strides[2], S = I ? r.strides[2] : 1, D = I ? 1 : r.strides[1], A = t.strides[0], T = I ? t.strides[1] : t.strides[2], N = I ? t.strides[2] : 1, F = I ? 1 : t.strides[1], M = 0; M < h; ++M)
					for (var O = 0; O < d; ++O)
						for (var P = 0; P < v; ++P)
							for (var B = P - E, L = Math.max(0, Math.ceil(B / b)), W = Math.min(y, (f + B) / b), z = 0; z < m; ++z) {
			...
			(Ih.prototype.conv2dDerFilter = function (t, e, n) {
				...
				for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = 'channelsLast' === n.dataFormat, u = cr(n.filterShape, 'float32'), c = n.padInfo.left, l = n.padInfo.top, h = this.bufferSync(t), f = this.bufferSync(e), p = 0; p < i; ++p)
					for (var d = Math.max(0, Math.ceil((l - p) / r)), v = Math.min(n.outHeight, (n.inHeight + l - p) / r), m = 0; m < a; ++m)
			...
			(Ih.prototype.conv3dDerFilter = function (t, e, n) {
				for (var r = n.strideDepth, o = n.strideHeight, i = n.strideWidth, a = n.filterDepth, s = n.filterHeight, u = n.filterWidth, c = cr(n.filterShape, 'float32'), l = c.values, h = c.strides, f = h[0], p = h[1], d = h[2], v = h[3], m = this.readSync(e.dataId), g = e.strides, y = g[0], x = g[1], b = g[2], w = g[3], C = this.readSync(t.dataId), E = t.strides, _ = E[0], I = E[1], R = E[2], k = E[3], S = n.padInfo.front, D = n.padInfo.left, A = n.padInfo.top, T = 0; T < a; ++T)
					for (var N = Math.max(0, Math.ceil((S - T) / r)), F = Math.min(n.outDepth, (n.inDepth + S - T) / r), M = T * f, O = 0; O < s; ++O)
						for (var P = Math.max(0, Math.ceil((A - O) / o)), B = Math.min(n.outHeight, (n.inHeight + A - O) / o), L = O * p + M, W = 0; W < u; ++W)
			...
			(Ih.prototype.depthwiseConv2D = function (t, e, n) {
				...
				for (var r = n.filterHeight, o = n.filterWidth, i = n.dilationHeight, a = n.dilationWidth, s = n.padInfo.left, u = n.padInfo.top, c = n.outChannels / n.inChannels, l = cr(n.outShape, t.dtype), h = this.readSync(t.dataId), f = this.readSync(e.dataId), p = l.values, d = 0; d < n.batchSize; ++d)
			...
			(Ih.prototype.depthwiseConv2DDerFilter = function (t, e, n) {
				...
				for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = cr(n.filterShape, 'float32'), u = n.padInfo.left, c = n.padInfo.top, l = n.outChannels / n.inChannels, h = this.bufferSync(t), f = this.bufferSync(e), p = 0; p < i; ++p)
					for (var d = Math.max(0, Math.ceil((c - p) / r)), v = Math.min(n.outHeight, (n.inHeight + c - p) / r), m = 0; m < a; ++m)
			...
			(Ih.prototype.maxPoolPositions = function (t, e) {
				for (var n = cr(e.outShape, 'int32'), r = e.strideHeight, o = e.strideWidth, i = e.dilationHeight, a = e.dilationWidth, s = e.effectiveFilterHeight, u = e.effectiveFilterWidth, c = e.padInfo.top, l = e.padInfo.left, h = this.bufferSync(t), f = 0; f < e.batchSize; ++f)
			...
			(Ih.prototype.maxPoolBackprop = function (t, e, n, r) {
				...
				for (var o = this.maxPoolPositions(e, r), i = r.strideHeight, a = r.strideWidth, s = r.dilationHeight, u = r.dilationWidth, c = r.effectiveFilterHeight, l = r.effectiveFilterWidth, h = l - 1 - r.padInfo.left, f = c - 1 - r.padInfo.top, p = cr(e.shape, 'float32'), d = this.bufferSync(o), v = this.bufferSync(t), m = 0; m < r.batchSize; ++m)
			...
			(Ih.prototype.avgPoolBackprop = function (t, e, n) {
				...
				for (var r = n.strideHeight, o = n.strideWidth, i = n.filterHeight, a = n.filterWidth, s = n.dilationHeight, u = n.dilationWidth, c = n.effectiveFilterHeight, l = n.effectiveFilterWidth, h = l - 1 - n.padInfo.left, f = c - 1 - n.padInfo.top, p = cr(e.shape, 'float32'), d = 1 / (i * a), v = this.bufferSync(t), m = 0; m < n.batchSize; ++m)
			...
			(Ih.prototype.maxPool3dPositions = function (t, e) {
				for (var n = cr(e.outShape, 'int32'), r = e.strideDepth, o = e.strideHeight, i = e.strideWidth, a = e.dilationDepth, s = e.dilationHeight, u = e.dilationWidth, c = e.effectiveFilterDepth, l = e.effectiveFilterHeight, h = e.effectiveFilterWidth, f = e.padInfo.front, p = e.padInfo.top, d = e.padInfo.left, v = this.bufferSync(t), m = 0; m < e.batchSize; ++m)
			...
			(Ih.prototype.resizeBilinear = function (t, e, n, r) {
				wh(t, 'resizeBilinear');
				for (var o = t.shape, i = o[0], a = o[1], s = o[2], u = o[3], c = this.readSync(t.dataId), l = new Float32Array(L([i, e, n, u])), h = [r && 1 < e ? a - 1 : a, r && 1 < n ? s - 1 : s], f = [r && 1 < e ? e - 1 : e, r && 1 < n ? n - 1 : n], p = 0, d = h[0] / f[0], v = h[1] / f[1], m = 0; m < i; m++)
					for (var g = 0; g < e; g++)
			...
			(Ih.prototype.resizeBilinearBackprop = function (t, e, n) {
				...
				for (var r = e.shape, o = r[0], i = r[1], a = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * i * a * s), f = [n && 1 < c ? i - 1 : i, n && 1 < l ? a - 1 : a], p = [n && 1 < c ? c - 1 : c, n && 1 < l ? l - 1 : l], d = f[0] / p[0], v = f[1] / p[1], m = this.readSync(t.dataId), g = 0, y = 0; y < o; y++)
			...
			(Ih.prototype.resizeNearestNeighbor = function (t, e, n, r) {
				...
				for (var o = t.shape, i = o[0], a = o[1], s = o[2], u = o[3], c = this.readSync(t.dataId), l = new Float32Array(i * e * n * u), h = [r && 1 < e ? a - 1 : a, r && 1 < n ? s - 1 : s], f = [r && 1 < e ? e - 1 : e, r && 1 < n ? n - 1 : n], p = h[0] / f[0], d = h[1] / f[1], v = 0, m = 0; m < i; m++)
					for (var g = m * t.strides[0], y = 0; y < e; y++)
						for (var x = p * y, b = g + Math.min(a - 1, r ? Math.round(x) : Math.floor(x)) * t.strides[1], w = 0; w < n; w++)
			...
			(Ih.prototype.resizeNearestNeighborBackprop = function (t, e, n) {
				...
				for (var r = e.shape, o = r[0], i = r[1], a = r[2], s = r[3], u = t.shape, c = u[1], l = u[2], h = new Float32Array(o * i * a * s), f = this.readSync(t.dataId), p = [n && 1 < c ? i - 1 : i, n && 1 < l ? a - 1 : a], d = [n && 1 < c ? c - 1 : c, n && 1 < l ? l - 1 : l], v = p[0] / d[0], m = p[1] / d[1], g = 1 / v, y = 1 / m, x = 2 * Math.ceil(g) + 2, b = 2 * Math.ceil(y) + 2, w = 0; w < o; w++)
			...
			(Ih.prototype.fftBatch = function (t, e) {
				for (var n = t.shape[0], r = t.shape[1], o = cr(t.shape, 'float32'), i = cr(t.shape, 'float32'), a = En(t).as2D(n, r), s = _n(t).as2D(n, r), u = 0; u < n; u++)
					for (var c = a.slice([u, 0], [1, r]), l = s.slice([u, 0], [1, r]), h = Cn(c, l), f = this.readSync(this.fftImpl(h, e).dataId), p = 0; p < r; p++) {
						var d = Oo(f, p);
			...
			(Ih.prototype.depthToSpace = function (t, e, n) {
				...
				for (var r = t.shape[0], o = t.shape[1], i = t.shape[2], a = t.shape[3], s = o * e, u = i * e, c = a / (e * e), l = this.readSync(t.dataId), h = new Float32Array(r * s * u * c), f = 0, p = 0; p < r; ++p)
					for (var d = 0; d < s; ++d)
			...
			(Ih.prototype.broadcastedBinaryOp = function (a, s, t, u) {
				var e = go(a.shape, s.shape),
					...
					p = vo(s.shape, e),
					d = c.values;
				if (f.length + p.length === 0) for (var n = 0; n < d.length; ++n) d[n] = u(l[n % l.length], h[n % h.length]);
				else {
			...
			(Ih.prototype.broadcastedBinaryComplexOp = function (s, u, c) {
				var t = go(s.shape, u.shape),
					l = cr(t, 'float32'),
					e = cr(t, 'float32'),
					h = this.readSync(s.dataId),
					f = this.readSync(u.dataId),
					p = vo(s.shape, t),
					d = vo(u.shape, t),
					v = l.values,
					m = e.values;
				if (p.length + d.length === 0)
					for (var n = 0; n < v.length; n++) {
						var r = n % h.length,
							o = n % f.length,
							i = c(h[2 * r], h[2 * r + 1], f[2 * o], f[2 * o + 1]);
					...
					var g = this.bufferSync(this.data.get(s.dataId).complexTensors.real),
						...
						a = function (t) {
							...
							var i = y.locToIndex(o),
								a = c(h[2 * r], h[2 * r + 1], f[2 * i], f[2 * i + 1]);
			...
			(Ih.prototype.cropAndResize = function (t, e, n, r, o, i) {
				for (var a = t.shape, s = a[0], u = a[1], c = a[2], l = a[3], h = e.shape[0], f = r[0], p = r[1], d = cr([h, f, p, l], 'float32'), v = this.readSync(e.dataId), m = this.readSync(n.dataId), g = this.readSync(t.dataId), y = t.strides, x = d.strides, b = 0; b < h; b++) {
					var w = 4 * b,
						...
						R = m[b];
					if (!(s <= R))
						for (var k = 1 < f ? ((_ - C) * (u - 1)) / (f - 1) : 0, S = 1 < p ? ((I - E) * (c - 1)) / (p - 1) : 0, D = 0; D < f; D++) {
							var A = 1 < f ? C * (u - 1) + D * k : 0.5 * (C + _) * (u - 1);
							if (A < 0 || u - 1 < A)
								for (var T = 0; T < p; T++)
									for (var N = 0; N < l; N++) {
								...
								var M = Math.floor(A),
									...
									P = A - M;
								for (T = 0; T < p; T++)
									if ((q = 1 < p ? E * (c - 1) + T * S : 0.5 * (E + I) * (c - 1)) < 0 || c - 1 < q) for (N = 0; N < l; N++) (F = N + T * x[2] + D * x[1] + b * x[0]), (d.values[F] = i);
									else {
										var B = Math.floor(q),
											L = Math.ceil(q),
											W = q - B;
						...
						var s = a.data.get(o.dataId).values,
							...
							c = (function (t, e, a, s, n, u) {
								var r = go(t, e),
									...
									m = vo(t, r),
									g = vo(e, r);
								if (m.length + g.length === 0) for (var o = 0; o < h.length; ++o) h[o] = u(a[o % a.length], s[o % s.length]);
								else {
									var i = function (t) {
										var e = it(t, c, l),
											n = e.slice(-f);
			...
			Nh = [
				{
					...
					kernelFunc: function (t) {
						...
						var d = _().getBool('WEBGL_PACK') ? new Ah(f) : new Dh(f),
							v = n.runWebGLProgram(d, [p], 'int32');
				...
				},
				{
					...
					kernelFunc: function (t) {
						...
						var o = e,
							...
							h = s.softNmsSigma,
							f = n,
							p = Lo(f.readSync(i.dataId), f.readSync(a.dataId), u, c, l, h);
						return [p.selectedIndices, p.selectedScores];
					},
				},
				{
	...
	for (
		...
		h(Mh[Fh]);
	var Oh =
		((Ph.prototype.fetch = function (t, e) {
			return fetch(t, e);
		}),
	...
	var Bh,
		Lh =
			((Wh.prototype.fetch = function (t, e) {
	...
	var zh = { float32: 4, int32: 4, uint16: 2, uint8: 1, bool: 1 },
		Uh = 4;
	function Vh(v, t) {
		for (
			var m = {},
	...
	function Kh(t) {
		...
		return { dateSaved: new Date(), modelTopologyType: 'JSON', modelTopologyBytes: null == t.modelTopology ? 0 : Hh(JSON.stringify(t.modelTopology)), weightSpecsBytes: null == t.weightSpecs ? 0 : Hh(JSON.stringify(t.weightSpecs)), weightDataBytes: null == t.weightData ? 0 : t.weightData.byteLength };
	}
	var Xh =
			...
			(Qh.getHandlers = function (n, t, r) {
				var o = [];
				return (
					('load' === t ? Qh.getInstance().loadRouters : Qh.getInstance().saveRouters).forEach(function (t) {
						var e = t(n, r);
						null !== e && o.push(e);
					}),
					o
		...
		$h =
			...
			(Jh.registerManager = function (t, e) {
				P(null != t, function () {
					...
					t.endsWith(Yh) && (t = t.slice(0, t.indexOf(Yh))),
					...
					switch (t.label) {
						case 0:
							return (
								...
								(n = e[0]),
								P(0 < (r = Xh.getSaveHandlers(h)).length, function () {
			...
			return new Promise(function (u, c) {
				...
				(l.onupgradeneeded = function () {
					...
					(l.onsuccess = function () {
						var r = l.result;
						if (null == h) {
							var t = r.transaction(ef, 'readonly'),
								e = t.objectStore(ef).get(f.modelPath);
							...
							var o,
								i = Kh(h),
								a = r.transaction(nf, 'readwrite'),
								s = a.objectStore(nf),
								n = s.put({ modelPath: f.modelPath, modelArtifactsInfo: i });
							(n.onsuccess = function () {
								var n = (o = r.transaction(ef, 'readwrite')).objectStore(ef).put({ modelPath: f.modelPath, modelArtifacts: h, modelArtifactsInfo: i });
								(n.onsuccess = function () {
	...
	var cf =
		((lf.prototype.listModels = function () {
			return y(this, void 0, void 0, function () {
				var e = this;
				return R(this, function (t) {
					return [
						...
						new Promise(function (i, n) {
							...
							(r.onupgradeneeded = function () {
								...
								(r.onsuccess = function () {
									var e = r.result,
										t = e.transaction(nf, 'readonly'),
										o = t.objectStore(nf).getAll();
		...
		(lf.prototype.removeModel = function (u) {
			return y(this, void 0, void 0, function () {
				...
				return R(this, function (t) {
					var e;
					return (
						(u = (e = u).startsWith(sf.URL_SCHEME) ? e.slice(sf.URL_SCHEME.length) : e),
						[
							2,
	...
	var hf = '/',
		...
		gf = 'model_metadata';
	function yf(t) {
		return { info: [ff, t, pf].join(hf), topology: [ff, t, df].join(hf), weightSpecs: [ff, t, vf].join(hf), weightData: [ff, t, mf].join(hf), modelMetadata: [ff, t, gf].join(hf) };
	}
	function xf(t) {
		var e = t.split(hf);
				...
				return R(this, function (t) {
					...
					try {
						return (
							...
							this.LS.setItem(this.keys.modelMetadata, JSON.stringify({ format: o.format, generatedBy: o.generatedBy, convertedBy: o.convertedBy, userDefinedMetadata: o.userDefinedMetadata })),
	...
	var Ef =
		((_f.prototype.listModels = function () {
			return y(this, void 0, void 0, function () {
				var e, n, r, o, i, a;
				return R(this, function (t) {
				...
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 1:
								return (
									(n = [{ paths: ['./' + this.weightDataFileName], weights: s.weightSpecs }]),
									(r = { modelTopology: s.modelTopology, format: s.format, generatedBy: s.generatedBy, convertedBy: s.convertedBy, weightsManifest: n }),
							...
							case 2:
								return (
									...
									null == s.weightData
										? [3, 4]
										: (((a = null == this.weightDataAnchor ? document.createElement('a') : this.weightDataAnchor).download = this.weightDataFileName),
										  (a.href = e),
										  [
												4,
												If(function () {
														...
														t.paths.forEach(function (r) {
															...
															(t.onload = function (t) {
																var e = t.target.result,
																	n = s.indexOf(r);
																(u[n] = e), -1 === u.indexOf(null) && c({ modelTopology: i, weightSpecs: a, weightData: qh(u), format: o.format, generatedBy: o.generatedBy, convertedBy: o.convertedBy, userDefinedMetadata: o.userDefinedMetadata });
															}),
																(t.onerror = function (t) {
					...
					switch (t.label) {
						case 0:
							...
							return (
								...
								[4, Tf(p, { requestInit: this.requestInit, fetchFunc: this.fetch, onProgress: this.onProgress })]
							);
						case 1:
	...
	var Vf,
		Gf = Object.freeze({
															...
															switch (t.label) {
																...
																case 1:
																	for (
																		...
																		(a = e[i]), (s = new Uint8Array(new Uint32Array([a.length]).buffer)), r.set(s, o), (o += Uh), r.set(a, o), (o += a.length);
																	return u(r), [2];
															}
														});
													});
			...
			fromMemory: function (t, e, n, r) {
				return 1 === arguments.length ? (null != t.modelTopology || null != t.weightSpecs ? new Lf(t) : (console.warn('Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release.'), new Lf({ modelTopology: t }))) : (console.warn('Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release.'), new Lf({ modelTopology: t, weightSpecs: e, weightData: n, trainingConfig: r }));
			},
		...
		Hf = wn({
			confusionMatrix_: function (t, e, n) {
				var r = cn(t, 'labels', 'confusionMatrix'),
					o = cn(e, 'predictions', 'confusionMatrix');
				...
				var i = wr(r.asType('int32'), n),
					a = wr(o.asType('int32'), n);
				return i.transpose().matMul(a).asType('int32');
			},
		}),
		qf = Object.freeze({ confusionMatrix: Hf }),
		jf = wn({
			fromPixels_: function (t, e) {
				...
				var s,
					...
					l = c[0],
					h = c[1];
				if ((a ? (s = t.getContext('2d').getImageData(0, 0, l, h).data) : r || n ? (s = t.data) : (i || o) && (null == Vf && (Vf = document.createElement('canvas').getContext('2d')), (Vf.canvas.width = l), (Vf.canvas.height = h), Vf.drawImage(t, 0, 0, l, h), (s = Vf.getImageData(0, 0, l, h).data)), 4 === e)) u = new Int32Array(s);
				else {
					var f = l * h;
		...
		Xf =
			((Jf.prototype.getClassName = function () {
	...
	function tp() {
		return 32 === Kt.backend.floatPrecision() ? 0.001 : 0.1;
	}
	function ep(t, e, n) {
		var r = !0;
	...
	var rp,
		...
		ap =
			(t(sp, (rp = Xf)),
			(sp.prototype.minimize = function (t, e, n) {
				void 0 === e && (e = !1);
			...
			(sp.prototype.saveIterations = function () {
				return y(this, void 0, void 0, function () {
					return R(this, function (t) {
						return null == this.iterations_ && (this.iterations_ = 0), [2, { name: 'iter', tensor: kn(this.iterations_, 'int32') }];
					});
				});
			}),
	...
	var up,
		cp =
			(t(lp, (up = ap)),
			(lp.prototype.applyGradients = function (n) {
				var u = this;
				(Array.isArray(n)
					? n.map(function (t) {
							return t.name;
	...
	var hp,
		fp =
			(t(pp, (hp = ap)),
			(pp.prototype.applyGradients = function (i) {
				var a = this;
				(Array.isArray(i)
					? i.map(function (t) {
							return t.name;
	...
	var dp,
		vp =
			(t(mp, (dp = ap)),
			(mp.prototype.applyGradients = function (p) {
				var d = this,
					t = Array.isArray(p)
						? p.map(function (t) {
								return t.name;
	...
	function mp(t, e, n, r) {
		...
		return (
			...
			null == r && (o.epsilon = Kt.backend.epsilon()),
			o
		);
	}
	Qf(vp);
	var gp,
		yp =
			(t(xp, (gp = ap)),
			(xp.prototype.applyGradients = function (p) {
				var d = this,
					t = Array.isArray(p)
						? p.map(function (t) {
								return t.name;
				...
				nn(function () {
					var h = tc(1, d.accBeta1),
						f = Wu(-d.learningRate, d.iteration.mul(d.decay).add(1));
					t.forEach(function (t, e) {
						var n = Kt.registeredVariables[t];
						null == d.accumulatedFirstMoment[e] && (d.accumulatedFirstMoment[e] = { originalName: t + '/m', variable: Un(n).variable(!1) }), null == d.accumulatedWeightedInfNorm[e] && (d.accumulatedWeightedInfNorm[e] = { originalName: t + '/v', variable: Un(n).variable(!1) });
						var r = Array.isArray(p) ? p[e].tensor : p[t];
						if (null != r) {
							var o = d.accumulatedFirstMoment[e].variable,
	...
	function xp(t, e, n, r, o) {
		...
		return (
			...
			null == r && (i.epsilon = Kt.backend.epsilon()),
			i
		);
	}
	Qf(yp);
	var bp,
		wp =
			(t(Cp, (bp = ap)),
			(Cp.prototype.applyGradients = function (o) {
				var i = this;
				(Array.isArray(o)
					? o.map(function (t) {
							return t.name;
	...
	var Ep,
		_p =
			(t(Ip, (Ep = wp)),
			(Ip.prototype.applyGradients = function (i) {
				var a = this;
				(Array.isArray(i)
					? i.map(function (t) {
							return t.name;
	...
	var Rp,
		kp =
			(t(Sp, (Rp = ap)),
			(Sp.prototype.applyGradients = function (e) {
				var h = this;
				(Array.isArray(e)
					? e.map(function (t) {
							return t.name;
	...
	var Dp =
			...
			(Np.rmsprop = function (t, e, n, r, o) {
				return void 0 === e && (e = 0.9), void 0 === n && (n = 0), void 0 === r && (r = null), void 0 === o && (o = !1), new kp(t, e, n, r, o);
			}),
			(Np.adam = function (t, e, n, r) {
				return void 0 === t && (t = 0.001), void 0 === e && (e = 0.9), void 0 === n && (n = 0.999), void 0 === r && (r = null), new vp(t, e, n, r);
			}),
			(Np.adadelta = function (t, e, n) {
				return void 0 === t && (t = 0.001), void 0 === e && (e = 0.95), void 0 === n && (n = null), new cp(t, e, n);
			}),
			(Np.adamax = function (t, e, n, r, o) {
				return void 0 === t && (t = 0.002), void 0 === e && (e = 0.9), void 0 === n && (n = 0.999), void 0 === r && (r = null), void 0 === o && (o = 0), new yp(t, e, n, r, o);
			}),
			(Np.adagrad = function (t, e) {
				return void 0 === e && (e = 0.1), new fp(t, e);
			}),
			Np),
		Ap = { sgd: Dp.sgd, momentum: Dp.momentum, adadelta: Dp.adadelta, adagrad: Dp.adagrad, rmsprop: Dp.rmsprop, adamax: Dp.adamax, adam: Dp.adam },
		Tp =
	...
	var Fp = Object.freeze({
		...
		grad: function (i) {
			return (
				...
				function (t, e) {
					var r = cn(t, 'x', 'tf.grad', null),
						o = null != e ? cn(e, 'dy', 'tf.grad') : null;
		...
		grads: function (i) {
			return (
				...
				function (t, e) {
					...
					var r = ln(t, 'args', 'tf.grads', null),
						o = null != e ? cn(e, 'dy', 'tf.grads') : null;
					return Kt.tidy(function () {
						var t = Kt.gradients(
								function () {
	...
	var Up =
		(Object.defineProperty(Vp.prototype, 'width', {
			get: function () {
				return this._width;
			},
			enumerable: !0,
		...
		Vp);
	function Vp(t, e) {
		if (!td(t) || !td(e)) throw new Error('Dimensions.constructor - expected width and height to be valid numbers, instead have ' + JSON.stringify({ width: t, height: e }));
	...
	var nd = Object.freeze({
		...
		rd =
			(Object.defineProperty(od.prototype, 'x', {
				get: function () {
					return this._x;
				},
				enumerable: !0,
	...
	var id =
		...
		(ad.prototype.calibrate = function (t) {
			return new ad({ left: this.left + t.left * this.width, top: this.top + t.top * this.height, right: this.right + t.right * this.width, bottom: this.bottom + t.bottom * this.height }).toSquare().round();
		}),
		ad);
	function ad(t, e) {
		void 0 === e && (e = !0);
		var n = t || {},
			r = [n.left, n.top, n.right, n.bottom].every(td),
			o = [n.x, n.y, n.width, n.height].every(td);
		...
		var i = o ? [n.x, n.y, n.width, n.height] : [n.left, n.top, n.right - n.left, n.bottom - n.top],
			...
			u = i[2],
			c = i[3];
		ad.assertIsValidBox({ x: a, y: s, width: u, height: c }, 'Box.constructor', e), (this._x = a), (this._y = s), (this._width = u), (this._height = c);
	}
	var sd,
		ud = (Pp(cd, (sd = id)), cd);
	...
	var ld =
		(Object.defineProperty(hd.prototype, 'score', {
			get: function () {
				return this._score;
			},
			enumerable: !0,
	...
	var fd,
		pd =
			(Pp(dd, (fd = ld)),
			(dd.prototype.forSize = function (t, e) {
	...
	function yd(s, u) {
		return nn(function () {
			var t = u[0],
				e = u[1],
				n = u[2],
				r = Bn(zp(s.shape.slice(0, 3), [1]), t),
				o = Bn(zp(s.shape.slice(0, 3), [1]), e),
				i = Bn(zp(s.shape.slice(0, 3), [1]), n),
				a = Vn([r, o, i], 3);
			return tc(s, a);
		});
	}
	...
	var _d =
		(Object.defineProperty(Id.prototype, 'shift', {
			get: function () {
		...
		(Id.prototype.align = function (t, e) {
			...
			var r = Object.assign({}, { useDlibAlignment: !1, minBoxPadding: 0.2 }, e),
	...
	var Rd,
		kd =
			(Pp(Sd, (Rd = _d)),
			(Sd.prototype.getRefPointsForAlignment = function () {
	...
	var Dd,
		Ad =
			(Pp(Td, (Dd = _d)),
			(Td.prototype.getJawOutline = function () {
	...
	var Nd =
		(Object.defineProperty(Fd.prototype, 'label', {
			get: function () {
				return this._label;
			},
			enumerable: !0,
	...
	var Md,
		Od =
			(Pp(Pd, (Md = id)),
			(Pd.assertIsValidLabeledBox = function (t, e) {
	...
	var Bd =
		(Object.defineProperty(Ld.prototype, 'label', {
			get: function () {
				return this._label;
			},
			enumerable: !0,
	...
	var Wd,
		...
		Ud =
			(Pp(Vd, (Wd = Od)),
			(Vd.assertIsValidPredictedBox = function (t, e) {
	...
	var Qd,
		...
		tv = {
			...
			monkeyPatch: function (t) {
				...
				var e = t.Canvas,
					n = void 0 === e ? zd.Canvas : e,
					r = t.Image,
					o = void 0 === r ? zd.Image : r;
				(zd.Canvas = n),
					(zd.Image = o),
					(zd.createCanvasElement =
						t.createCanvasElement ||
						function () {
							return new n();
						}),
					(zd.createImageElement =
						t.createImageElement ||
						function () {
							return new o();
						}),
					(zd.ImageData = t.ImageData || zd.ImageData),
					(zd.Video = t.Video || zd.Video),
					(zd.fetch = t.fetch || zd.fetch),
					(zd.readFile = t.readFile || zd.readFile);
			},
			isBrowser: Xd,
			isNodejs: Yd,
		};
	...
	var rv = function (t) {
		...
		ov =
			((iv.prototype.measureWidth = function (e) {
			...
			(iv.prototype.getUpperLeft = function (t, e) {
				var n = this.options.anchorPosition,
					r = n === Qd.BOTTOM_RIGHT || n === Qd.TOP_RIGHT,
					o = n === Qd.BOTTOM_LEFT || n === Qd.BOTTOM_RIGHT,
	...
	function pv(t) {
		var e = t.width,
			n = t.height,
			r = (0, tv.getEnv().createCanvasElement)();
		...
		return Lp(this, void 0, void 0, function () {
			...
			return Wp(this, function (t) {
				switch (t.label) {
					case 0:
						return (
							(e = u || tv.getEnv().createCanvasElement()),
							(n = s.shape.slice(jp(s) ? 1 : 0)),
							(r = n[0]),
							(o = n[1]),
							(i = n[2]),
							(a = nn(function () {
	...
	function gv(t, e, n) {
		...
		var a = fv(t),
			...
			u = s * a.width,
			c = s * a.height,
			l = pv({ width: e, height: e }),
			h = t instanceof i ? t : dv(t),
			f = Math.abs(u - c) / 2,
			p = n && u < c ? f : 0,
			d = n && c < u ? f : 0;
	...
	var yv =
		(Object.defineProperty(xv.prototype, 'imageTensors', {
			get: function () {
	...
	var kv =
		(Object.defineProperty(Sv.prototype, 'params', {
			get: function () {
				return this._params;
			},
			enumerable: !0,
	...
	function Uv(t, e) {
		var o = Mv(t, e),
			i = Bv(t, e);
		function a(t, e, n, r) {
			return void 0 === r && (r = !1), { conv0: r ? o(t, e, 3, n + '/conv0') : i(t, e, n + '/conv0'), conv1: i(e, e, n + '/conv1'), conv2: i(e, e, n + '/conv2') };
		}
		return {
	...
	function Gv(t, e) {
		...
		return {
			extractDenseBlock3Params: function (t, e) {
				return void 0 === e && (e = !1), { conv0: e ? r(t + '/conv0') : o(t + '/conv0'), conv1: o(t + '/conv1'), conv2: o(t + '/conv2') };
			},
			extractDenseBlock4Params: function (t, e) {
				return void 0 === e && (e = !1), { conv0: e ? r(t + '/conv0') : o(t + '/conv0'), conv1: o(t + '/conv1'), conv2: o(t + '/conv2'), conv3: o(t + '/conv3') };
			},
		};
	}
	var Hv,
		qv =
			(Pp(jv, (Hv = kv)),
			(jv.prototype.forwardInput = function (e) {
				var n = this.params;
			...
			(jv.prototype.extractParamsFromWeigthMap = function (t) {
				return (function (t) {
					var e = [],
						n = Gv(t, e).extractDenseBlock4Params,
			...
			(jv.prototype.extractParams = function (t) {
				return (function (t) {
					var e = [],
						...
						i = Uv(r, e).extractDenseBlock4Params,
						a = i(3, 32, 'dense0', !0),
						s = i(32, 64, 'dense1'),
						u = i(64, 128, 'dense2'),
						c = i(128, 256, 'dense3');
	...
	var Yv,
		$v =
			(Pp(Jv, (Yv = kv)),
			Object.defineProperty(Jv.prototype, 'faceFeatureExtractor', {
				get: function () {
	...
	var Qv = ['neutral', 'happy', 'sad', 'angry', 'fearful', 'disgusted', 'surprised'],
		Zv =
			((tm.prototype.asSortedArray = function () {
				var e = this;
	...
	var em,
		nm =
			(Pp(rm, (em = $v)),
			(rm.prototype.forwardInput = function (t) {
				var e = this;
				return nn(function () {
	...
	function sm(t, e) {
		var n = t.detection.box,
			...
			a = { landmarks: r, unshiftedLandmarks: e, alignedRect: new pd(t.detection.score, o.rescale(i.reverse()), i) };
		...
		cm =
			((lm.prototype.draw = function (t) {
				var e = nv(t),
					...
					s = n.pointSize,
					u = n.pointColor;
				r && this.faceLandmarks instanceof Ad && ((e.strokeStyle = a), (e.lineWidth = i), Mp(e, this.faceLandmarks.getJawOutline()), Mp(e, this.faceLandmarks.getLeftEyeBrow()), Mp(e, this.faceLandmarks.getRightEyeBrow()), Mp(e, this.faceLandmarks.getNose()), Mp(e, this.faceLandmarks.getLeftEye(), !0), Mp(e, this.faceLandmarks.getRightEye(), !0), Mp(e, this.faceLandmarks.getMouth(), !0)),
					o &&
						((e.strokeStyle = u),
						(e.fillStyle = u),
		...
		drawDetections: function (o, t) {
			(Array.isArray(t) ? t : [t]).forEach(function (t) {
				var e = t instanceof pd ? t.score : Gd(t) ? t.detection.score : void 0,
					n = t instanceof pd ? t.box : Gd(t) ? t.detection.box : new id(t),
					r = e ? '' + Yp(e) : void 0;
	...
	function fm(t, e) {
			...
			a = (function (t, e) {
				...
				return {
					...
					extractReductionBlockParams: function (t, e, n) {
						return { separable_conv0: o(t, e, n + '/separable_conv0'), separable_conv1: o(e, e, n + '/separable_conv1'), expansion_conv: r(t, e, 1, n + '/expansion_conv') };
					},
					extractMainBlockParams: function (t, e) {
						return { separable_conv0: o(t, t, e + '/separable_conv0'), separable_conv1: o(t, t, e + '/separable_conv1'), separable_conv2: o(t, t, e + '/separable_conv2') };
					},
				};
			})(o, n),
		...
		var p = { reduction_block: c(128, 256, 'exit_flow/reduction_block'), separable_conv: u(256, 512, 'exit_flow/separable_conv') };
			...
			r = (function (t, e) {
				...
				return {
					...
					extractReductionBlockParams: function (t) {
						return { separable_conv0: o(t + '/separable_conv0'), separable_conv1: o(t + '/separable_conv1'), expansion_conv: r(t + '/expansion_conv') };
					},
					extractMainBlockParams: function (t) {
						return { separable_conv0: o(t + '/separable_conv0'), separable_conv1: o(t + '/separable_conv1'), separable_conv2: o(t + '/separable_conv2') };
					},
				};
			})(t, n),
	...
	var mm,
		...
		ym =
			(Pp(xm, (mm = kv)),
			(xm.prototype.forwardInput = function (n) {
				var r = this,
					o = this.params;
				...
				return nn(function () {
					...
					return (
						(e = vm((e = vm(e, o.entry_flow.reduction_block_0, !1)), o.entry_flow.reduction_block_1)),
						Zp(r._numMainBlocks, 0, 1).forEach(function (t) {
							e = (function (t, e) {
						...
						(e = vm(e, o.exit_flow.reduction_block)),
						(e = dl(Dv(e, o.exit_flow.separable_conv, [1, 1])))
					);
				});
			}),
	...
	var bm,
		wm =
			(Pp(Cm, (bm = kv)),
			Object.defineProperty(Cm.prototype, 'faceFeatureExtractor', {
				get: function () {
					return this._faceFeatureExtractor;
				},
				enumerable: !0,
												...
												return Lp(u, void 0, void 0, function () {
													...
													return Wp(this, function (t) {
														switch (t.label) {
															...
															case 2:
																return (n = t.sent()[0]), (o = (r = 0.5 < n) ? c.Gender.MALE : c.Gender.FEMALE), (i = r ? n : 1 - n), a.dispose(), s.dispose(), [2, { age: e, gender: o, genderProbability: i }];
														}
													});
												});
											})
	...
	var Em,
		_m =
			(Pp(Im, (Em = $v)),
			(Im.prototype.postProcess = function (t, o, e) {
	...
	var Rm,
		km =
			(Pp(Sm, (Rm = _m)),
			(Sm.prototype.getDefaultModelName = function () {
	...
	var Dm,
		Am =
			(Pp(Tm, (Dm = kv)),
			(Tm.prototype.forwardInput = function (e) {
				var n = this.params;
			...
			(Tm.prototype.extractParamsFromWeigthMap = function (t) {
				return (function (t) {
					var e = [],
						n = Gv(t, e).extractDenseBlock3Params,
			...
			(Tm.prototype.extractParams = function (t) {
				return (function (t) {
					var e = [],
						...
						r = n.extractWeights,
						o = n.getRemainingWeights,
						i = Uv(r, e).extractDenseBlock3Params,
						a = i(3, 32, 'dense0', !0),
						s = i(32, 64, 'dense1'),
						u = i(64, 128, 'dense2');
					if (0 !== o().length) throw new Error('weights remaing after extract: ' + o().length);
	...
	var Nm,
		Fm =
			(Pp(Mm, (Nm = _m)),
			(Mm.prototype.getDefaultModelName = function () {
	...
	function Um(a, s) {
		...
		return {
			...
			extractResidualLayerParams: function (t, e, n, r, o) {
				return void 0 === o && (o = !1), { conv1: i((o ? 0.5 : 1) * t, e, n, r + '/conv1'), conv2: i(t, e, n, r + '/conv2') };
			},
		};
	}
	function Vm(t, e) {
	...
	var qm,
		jm =
			(Pp(Km, (qm = kv)),
			(Km.prototype.forwardInput = function (n) {
				var r = this.params;
			...
			(Km.prototype.extractParamsFromWeigthMap = function (t) {
				return (function (t) {
					var e = [],
						...
						b = t.fc;
					if ((e.push({ originalPath: 'fc', paramPath: 'fc' }), !Hp(b))) throw new Error('expected weightMap[fc] to be a Tensor2D, instead have ' + b);
					var w = { conv32_down: i, conv32_1: a, conv32_2: s, conv32_3: u, conv64_down: c, conv64_1: l, conv64_2: h, conv64_3: f, conv128_down: p, conv128_1: d, conv128_2: v, conv256_down: m, conv256_1: g, conv256_2: y, conv256_down_out: x, fc: b };
			...
			(Km.prototype.extractParams = function (t) {
				return (function (t) {
					...
					return { params: { conv32_down: u, conv32_1: c, conv32_2: l, conv32_3: h, conv64_down: f, conv64_1: p, conv64_2: d, conv64_3: v, conv128_down: m, conv128_1: g, conv128_2: y, conv256_down: x, conv256_1: b, conv256_2: w, conv256_down_out: C, fc: E }, paramMappings: o };
				})(t);
			}),
			Km);
	function Km() {
	...
	var Jm =
		(Object.defineProperty(Qm.prototype, 'minFaceSize', {
			get: function () {
	...
	function Qm(t) {
		var e = void 0 === t ? {} : t,
			...
			i = e.scoreThresholds,
			a = e.scaleSteps;
		if (((this._name = 'MtcnnOptions'), (this._minFaceSize = n || 20), (this._scaleFactor = r || 0.709), (this._maxNumScales = o || 10), (this._scoreThresholds = i || [0.6, 0.7, 0.7]), (this._scaleSteps = a), 'number' != typeof this._minFaceSize || this._minFaceSize < 0)) throw new Error(this._name + ' - expected minFaceSize to be a number > 0');
	...
	function tg(t) {
		var e = [],
			n = (function (t, e) {
				var i = Wv(t, e);
				function a(t, e, n) {
					return { filters: i(t + '/Conv2d_' + e + '_pointwise/weights', 4, n + '/filters'), batch_norm_offset: i(t + '/Conv2d_' + e + '_pointwise/convolution_bn_offset', 1, n + '/batch_norm_offset') };
				}
				function n(t) {
				...
				function o(t) {
					return { box_encoding_predictor: r('Prediction/BoxPredictor_' + t + '/BoxEncodingPredictor', 'prediction_layer/box_predictor_' + t + '/box_encoding_predictor'), class_predictor: r('Prediction/BoxPredictor_' + t + '/ClassPredictor', 'prediction_layer/box_predictor_' + t + '/class_predictor') };
				}
				return {
					extractMobilenetV1Params: function () {
						return { conv_0: a('MobilenetV1', 0, 'mobilenetv1/conv_0'), conv_1: n(1), conv_2: n(2), conv_3: n(3), conv_4: n(4), conv_5: n(5), conv_6: n(6), conv_7: n(7), conv_8: n(8), conv_9: n(9), conv_10: n(10), conv_11: n(11), conv_12: n(12), conv_13: n(13) };
					},
					extractPredictionLayerParams: function () {
		...
		if ((e.push({ originalPath: 'Output/extra_dim', paramPath: 'output_layer/extra_dim' }), !qp(i))) throw new Error("expected weightMap['Output/extra_dim'] to be a Tensor3D, instead have " + i);
	...
	var ng = 0.0010000000474974513;
	function rg(t, e) {
		return nn(function () {
			var o = null,
				i = eg(t, e.conv_0, [2, 2]);
			if (
				([e.conv_1, e.conv_2, e.conv_3, e.conv_4, e.conv_5, e.conv_6, e.conv_7, e.conv_8, e.conv_9, e.conv_10, e.conv_11, e.conv_12, e.conv_13].forEach(function (t, e) {
					var n = e + 1,
						r = (function (e) {
	...
	function ig(t, e) {
		var n = (function (t) {
				var e = Br(gl(t, [1, 0])),
					n = [tc(e[2], e[0]), tc(e[3], e[1])];
				return { sizes: n, centers: [Ou(e[0], Wu(n[0], kn(2))), Ou(e[1], Wu(n[1], kn(2)))] };
			})(t),
			r = n.sizes,
			o = n.centers,
			i = Br(gl(e, [1, 0])),
			a = Wu(Yu(Ks(Wu(i[2], kn(5))), r[0]), kn(2)),
			s = Ou(Yu(Wu(i[0], kn(10)), r[0]), o[0]),
			u = Wu(Yu(Ks(Wu(i[3], kn(5))), r[1]), kn(2)),
	...
	function ag(e, n) {
		return nn(function () {
			var t = e.shape[0];
			return { boxPredictionEncoding: Tr(Nv(e, n.box_encoding_predictor), [t, -1, 1, 4]), classPrediction: Tr(Nv(e, n.class_predictor), [t, -1, 3]) };
		});
	}
	var sg =
		(Object.defineProperty(ug.prototype, 'minConfidence', {
			get: function () {
	...
	var cg,
		lg =
			(Pp(hg, (cg = kv)),
			(hg.prototype.forwardInput = function (r) {
				var o = this.params;
				if (!o) throw new Error('SsdMobilenetv1 - load model before inference');
				return nn(function () {
					var t = r.toBatchTensor(512, !1).toFloat(),
						e = rg(tc(Yu(t, kn(0.007843137718737125)), kn(1)), o.mobilenetv1),
						n = (function (l, h, f) {
							return nn(function () {
								var t = eg(eg(l, f.conv_0, [1, 1]), f.conv_1, [2, 2]),
									e = eg(eg(t, f.conv_2, [1, 1]), f.conv_3, [2, 2]),
									n = eg(eg(e, f.conv_4, [1, 1]), f.conv_5, [2, 2]),
									r = eg(eg(n, f.conv_6, [1, 1]), f.conv_7, [2, 2]),
									o = ag(h, f.box_predictor_0),
									i = ag(l, f.box_predictor_1),
									a = ag(t, f.box_predictor_2),
									s = ag(e, f.box_predictor_3),
									u = ag(n, f.box_predictor_4),
									c = ag(r, f.box_predictor_5);
								return { boxPredictions: Vn([o.boxPredictionEncoding, i.boxPredictionEncoding, a.boxPredictionEncoding, s.boxPredictionEncoding, u.boxPredictionEncoding, c.boxPredictionEncoding], 1), classPredictions: Vn([o.classPrediction, i.classPrediction, a.classPrediction, s.classPrediction, u.classPrediction, c.classPrediction], 1) };
							});
						})(e.out, e.conv11, o.prediction_layer);
					return (function (o, i, a) {
						return nn(function () {
							var t = o.shape[0],
								e = ig(Tr(Or(a.extra_dim, [t, 1, 1]), [-1, 4]), Tr(o, [-1, 4]));
							e = Tr(e, [t, e.shape[0] / t, 4]);
							var n = ru(Xc(i, [0, 0, 1], [-1, -1, -1])),
								r = Xc(n, [0, 0, 0], [-1, -1, 1]);
									...
									return (
										...
										(b = d.map(function (t) {
											var e = [Math.max(0, x[t][0]), Math.min(1, x[t][2])].map(function (t) {
												...
												n = e[0],
												r = e[1],
												o = [Math.max(0, x[t][1]), Math.min(1, x[t][3])].map(function (t) {
													return t * g;
												}),
												i = o[0],
												a = o[1];
											return new pd(h[t], new Cd(i, n, a - i, r - n), { height: s.getInputHeight(0), width: s.getInputWidth(0) });
										})),
										u.dispose(),
										c.dispose(),
										[2, b]
	...
	var mg,
		gg = [new rd(0.738768, 0.874946), new rd(2.42204, 2.65704), new rd(4.30971, 7.04493), new rd(10.246, 4.59428), new rd(12.6868, 11.8741)],
	...
	function Cg(e) {
		return nn(function () {
			var t = Yu(e, kn(0.10000000149011612));
	...
	var kg =
		(Object.defineProperty(Sg.prototype, 'inputSize', {
			get: function () {
				return this._inputSize;
			},
			enumerable: !0,
	...
	var Dg,
		Ag =
			(Pp(Tg, (Dg = kv)),
			Object.defineProperty(Tg.prototype, 'config', {
				get: function () {
					return this._config;
				},
				enumerable: !0,
							...
							switch (t.label) {
								...
								case 2:
									return (
										...
										(s = { width: o.getInputWidth(0), height: o.getInputHeight(0) }),
			...
			(Tg.prototype.extractParams = function (t) {
				var e = this.config.filterSizes || Tg.DEFAULT_FILTER_SIZES,
					n = e ? e.length : void 0;
				...
				return (function (t, e, n, r) {
					...
					if (e.withSeparableConvs) {
						var p = r[0],
							...
							b = r[7],
							w = r[8];
						o = { conv0: e.isFirstLayerConv2d ? l(p, d, 3, 'conv0') : f(p, d, 'conv0'), conv1: f(d, v, 'conv1'), conv2: f(v, m, 'conv2'), conv3: f(m, g, 'conv3'), conv4: f(g, y, 'conv4'), conv5: f(y, x, 'conv5'), conv6: b ? f(x, b, 'conv6') : void 0, conv7: w ? f(b, w, 'conv7') : void 0, conv8: l(w || b || x, 5 * n, 1, 'conv8') };
					} else (p = r[0]), (d = r[1]), (v = r[2]), (m = r[3]), (g = r[4]), (y = r[5]), (x = r[6]), (b = r[7]), (w = r[8]), (o = { conv0: h(p, d, 'conv0'), conv1: h(d, v, 'conv1'), conv2: h(v, m, 'conv2'), conv3: h(m, g, 'conv3'), conv4: h(g, y, 'conv4'), conv5: h(y, x, 'conv5'), conv6: h(x, b, 'conv6'), conv7: h(b, w, 'conv7'), conv8: l(w, 5 * n, 1, 'conv8') });
					...
					return Wp(this, function (t) {
						switch (t.label) {
							...
							case 4:
								...
								(g = 0), (t.label = 5);
							case 5:
								return g < s ? ((y = bd(p[v][m][g][0])), !F || F < y ? ((x = ((m + bd(d[v][m][g][0])) / a) * o), (b = ((v + bd(d[v][m][g][1])) / a) * i), (w = ((Math.exp(d[v][m][g][2]) * this.config.anchors[g].x) / a) * o), (C = ((Math.exp(d[v][m][g][3]) * this.config.anchors[g].y) / a) * i), (E = x - w / 2), (_ = b - C / 2), (I = { row: v, col: m, anchor: g }), this.withClassScores ? [4, this.extractPredictedClass(h, I)] : [3, 7]) : [3, 9]) : [3, 10];
							case 6:
								return (D = t.sent()), [3, 8];
							case 7:
								(D = { classScore: 1, label: 0 }), (t.label = 8);
							case 8:
								(k = (R = D).classScore), (S = R.label), f.push(Bp({ box: new ud(E, _, E + w, _ + C), score: y, classScore: y * k, label: S }, I)), (t.label = 9);
							case 9:
								return g++, [3, 5];
							case 10:
								return m++, [3, 4];
			...
			(Tg.DEFAULT_FILTER_SIZES = [3, 16, 32, 64, 128, 256, 512, 1024, 1024]),
			Tg);
	function Tg(t) {
	...
	var Ng,
		Fg =
			(Pp(Mg, (Ng = Ag)),
			Object.defineProperty(Mg.prototype, 'withSeparableConvs', {
				get: function () {
	...
	function Mg(t) {
		void 0 === t && (t = !0);
		var e = Object.assign({}, { withSeparableConvs: t, iouThreshold: 0.4, classes: ['face'] }, t ? { anchors: yg, meanRgb: xg } : { anchors: gg, withClassScores: !0 });
	...
	function Hg(t) {
		var e = zv(t),
			...
			i = (function (r, o) {
				...
				function h(t, e, n) {
					return void 0 === n && (n = !1), { conv1: u(t[0], t[1], 3, e + '/conv1'), prelu1_alpha: l(t[1], e + '/prelu1_alpha'), conv2: u(t[1], t[2], 3, e + '/conv2'), prelu2_alpha: l(t[2], e + '/prelu2_alpha'), conv3: u(t[2], t[3], n ? 2 : 3, e + '/conv3'), prelu3_alpha: l(t[3], e + '/prelu3_alpha') };
				}
				return {
					...
					extractONetParams: function () {
						...
						return Bp(Bp({}, t), { conv4: e, prelu4_alpha: n, fc1: r, prelu5_alpha: o, fc2_1: i, fc2_2: a, fc2_3: s });
					},
				};
			})(n, o),
	...
	function qg(t) {
		var e = [],
			n = (function (t, e) {
				...
				function h(t) {
					return { conv1: u(t + '/conv1'), prelu1_alpha: l(t + '/prelu1_alpha'), conv2: u(t + '/conv2'), prelu2_alpha: l(t + '/prelu2_alpha'), conv3: u(t + '/conv3'), prelu3_alpha: l(t + '/prelu3_alpha') };
				}
				return {
					extractPNetParams: function () {
						var t = h('pnet'),
	...
	function $g(t) {
		return nn(function () {
			return Yu(tc(t, kn(127.5)), kn(0.0078125));
		});
	}
	function Jg(t, e) {
		return nn(function () {
				...
				.map(function (a) {
					return nn(function () {
						var t = { scale: a },
							...
							o = r.prob,
							i = r.regions;
						return (t.pnet = Date.now() - n), { scoresTensor: Br(Br(o, 3)[1])[0], regionsTensor: Br(i)[0], scale: a, statsForScale: t };
					});
				})
				.map(function (t) {
						...
						i = (function (t, o, i, e) {
							...
							return n.map(function (t) {
								var e = new ud(Math.round((t.y * Vg + 1) / i), Math.round((t.x * Vg + 1) / i), Math.round((t.y * Vg + Gg) / i), Math.round((t.x * Vg + Gg) / i)),
									n = a[t.y][t.x],
									r = o.arraySync();
								return { cell: e, score: n, region: new Xg(r[t.y][t.x][0], r[t.y][t.x][1], r[t.y][t.x][2], r[t.y][t.x][3]) };
							});
						})(e, n, r, u);
							...
							switch (t.label) {
								case 0:
									...
									return (
										...
										(g = Date.now()),
										[4, Zg(i, m, d[0], e.pnet, r)]
									);
								case 1:
									return (y = t.sent()), (r.total_stage1 = Date.now() - g), y.boxes.length ? ((r.stage2_numInputBoxes = y.boxes.length), (g = Date.now()), [4, ey(n, y.boxes, d[1], e.rnet, r)]) : [2, a({ results: [], stats: r })];
								case 2:
									return (x = t.sent()), (r.total_stage2 = Date.now() - g), x.boxes.length ? ((r.stage3_numInputBoxes = x.boxes.length), (g = Date.now()), [4, ny(n, x.boxes, d[2], e.onet, r)]) : [2, a({ results: [], stats: r })];
								case 3:
									return (
										(b = t.sent()),
										...
										(w = b.boxes.map(function (e, t) {
											return sm(
												Hd({}, new pd(b.scores[t], new Cd(e.left / c, e.top / u, e.width / c, e.height / u), { height: u, width: c })),
												new kd(
	...
	var ay,
		...
		uy = [117.001, 114.697, 97.404],
		cy =
			(Pp(ly, (ay = Ag)),
			Object.defineProperty(ly.prototype, 'anchors', {
				get: function () {
					return this.config.anchors;
				},
				enumerable: !0,
			...
			ly);
	function ly() {
		var t = { withSeparableConvs: !0, iouThreshold: 0.4, classes: ['face'], anchors: sy, meanRgb: uy, isFirstLayerConv2d: !0, filterSizes: [3, 16, 32, 64, 128, 256, 512] };
	...
	var dy,
		vy = { ssdMobilenetv1: new lg(), tinyFaceDetector: new cy(), tinyYolov2: new Fg(), mtcnn: new oy(), faceLandmark68Net: new km(), faceLandmark68TinyNet: new Fm(), faceRecognitionNet: new jm(), faceExpressionNet: new nm(), ageGenderNet: new wm() },
		my = py,
		gy = hy,
		yy = fy,
		xy = (Pp(by, (dy = Lg)), by);
	...
	var Ay,
		Ty =
			(Pp(Ny, (Ay = Iy)),
			(Ny.prototype.withAgeAndGender = function () {
	...
	var rx,
		ox =
			(Pp(ix, (rx = Lg)),
			Object.defineProperty(ix.prototype, 'landmarkNet', {
				get: function () {
	...
	var Ix =
		(Object.defineProperty(Rx.prototype, 'labeledDescriptors', {
			get: function () {
	...
	(c.AgeGenderNet = wm),
		...
		(c.Box = id),
		(c.ComposableTask = Lg),
		(c.ComputeAllFaceDescriptorsTask = Qy),
		(c.ComputeFaceDescriptorsTaskBase = Yy),
		(c.ComputeSingleFaceDescriptorTask = ex),
		(c.DetectAllFaceLandmarksTask = sx),
		(c.DetectAllFacesTask = mx),
		(c.DetectFaceLandmarksTaskBase = ox),
		(c.DetectFacesTaskBase = px),
		(c.DetectSingleFaceLandmarksTask = lx),
		(c.DetectSingleFaceTask = xx),
		(c.Dimensions = Up),
		(c.FACE_EXPRESSION_LABELS = Qv),
		(c.FaceDetection = pd),
		(c.FaceDetectionNet = dg),
		(c.FaceExpressionNet = nm),
		(c.FaceExpressions = Zv),
		(c.FaceLandmark68Net = km),
		(c.FaceLandmark68TinyNet = Fm),
		(c.FaceLandmarkNet = Pm),
		(c.FaceLandmarks = _d),
		(c.FaceLandmarks5 = kd),
		(c.FaceLandmarks68 = Ad),
		(c.FaceMatch = Nd),
		(c.FaceMatcher = Ix),
		(c.FaceRecognitionNet = jm),
		(c.LabeledBox = Od),
		(c.LabeledFaceDescriptors = Bd),
		(c.Mtcnn = oy),
		(c.MtcnnOptions = Jm),
		(c.NetInput = yv),
		(c.NeuralNetwork = kv),
		(c.ObjectDetection = ld),
		(c.Point = rd),
		(c.PredictedBox = Ud),
		(c.Rect = Cd),
		(c.SsdMobilenetv1 = lg),
		(c.SsdMobilenetv1Options = sg),
		(c.TinyFaceDetector = cy),
		(c.TinyFaceDetectorOptions = Pg),
		(c.TinyYolov2 = Fg),
		(c.TinyYolov2Options = kg),
		(c.allFaces = Ex),
		...
		(c.awaitMediaLoaded = lv),
		(c.bufferToImage = hv),
		(c.computeFaceDescriptor = function (t) {
			return vy.faceRecognitionNet.computeFaceDescriptor(t);
		}),
		(c.createCanvas = pv),
		(c.createCanvasFromMedia = dv),
		...
		(c.detectAllFaces = wx),
		(c.detectFaceLandmarks = fy),
		(c.detectFaceLandmarksTiny = function (t) {
			return vy.faceLandmark68TinyNet.detectLandmarks(t);
		}),
		(c.detectLandmarks = yy),
		(c.detectSingleFace = function (t, e) {
			return void 0 === e && (e = new sg()), new xx(t, e);
		}),
		(c.draw = hm),
		(c.env = tv),
		(c.euclideanDistance = _x),
		(c.extendWithAge = Ym),
		(c.extendWithFaceDescriptor = Xm),
		(c.extendWithFaceDetection = Hd),
		(c.extendWithFaceExpressions = im),
		(c.extendWithFaceLandmarks = sm),
		(c.extendWithGender = $m),
		(c.extractFaceTensors = Cv),
		(c.extractFaces = wv),
		...
		(c.fetchOrThrow = Ev),
		(c.getContext2dOrThrow = nv),
		(c.getMediaDimensions = fv),
		(c.imageTensorToCanvas = vv),
		(c.imageToSquare = gv),
		...
		(c.isWithFaceDetection = Gd),
		(c.isWithFaceExpressions = om),
		(c.isWithFaceLandmarks = am),
